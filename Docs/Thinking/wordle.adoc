...
When player two makes a guess, player one computes a score for the guess. This
score is presented back to player two by coloring the letters of the guess:
