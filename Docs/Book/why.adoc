...
that a variable has the right type: it either does or it doesnt.
...
checking system, they 'just work™'.footnote:[Star is not speical here,
...
throws an exception, but the type of the exception is itself dependent
on other types.
