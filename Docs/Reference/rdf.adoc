...
to parse _ontology_ files using a variant of the Turtle <<w3ttl,standard>> for
...
notation often used called `Turtle` (Terse RDF Triple Language).
...
concepts. Such a statement is called a _Triple_. Turtle supports
