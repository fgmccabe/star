...
main function, then the package can be invoked as though it were an
executable program.

There are two kinds of main function: a function or procedure with
...
For example, if `main` is defined with the
