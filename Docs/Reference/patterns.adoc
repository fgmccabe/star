...
concstructor pattern is part of the scope extension of the variable. Similarly, a variable in a pattern on the left of a conjuction is also in scope in the right hand part of the conjunction.
