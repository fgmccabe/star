...
record --> identifier, ["{"], recordElement * [". "], ["}"].
recRecord --> identifier, ["{."], recordElement * [". "], [".}"].
...
[source,star]
----
recRecord --> identifier, ["{."], definition * [". "], [".}"].
----
...
letEnvironment --> ["{"], recordElement * [". "], ["}"].
letEnvironment --> ["{."], definition * [". "], [".}"].
----
