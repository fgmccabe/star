...
[#procedureRuleExpression]
=== Procedure Rule
(((procedure rule)))
(((rule)))

Procedure rules are the procedure analog of lambda expressions: they denote an anonymous procedure. Procedure rules take the form:
