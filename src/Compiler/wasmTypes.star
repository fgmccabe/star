star.compiler.wasm.types{
  ...
  public value_type ::= .NumType(num_type) | .VecType(vec_type) | .RefType(ref_type).
  public result_type ~> cons[value_type].
  public func_type ::= .FuncType(result_type,result_type)
