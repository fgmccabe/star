star.compiler.assem{
  ...
  showMnem([iICmp(XX),..Ins],Pc,Out) => showMnem(Ins,Pc+3,[Out..,disp(Pc),ss(":"),ss("ICmp"),ss(" "),disp(XX),ss("\n")]).
  ...
  showMnem([iFCmp(XX),..Ins],Pc,Out) => showMnem(Ins,Pc+3,[Out..,disp(Pc),ss(":"),ss("FCmp"),ss(" "),disp(XX),ss("\n")]).
