star.compiler.assem{
  ...
  mnem(.iTry(U,V),Pc,Lbls,Lts,Lcs,Lns) where (Lt1,LtNo) .= findLit(Lts,.strg(U::string)) && (Blk,Pc1,Lts1,Lns1) .= assemBlock(V,[],Pc+1,[.none,..Lbls],Lt1,Lcs,Lns) =>
    ([.intgr(25),.intgr(LtNo),mkTpl(Blk::cons[data])],Pc1,Lts1,Lns1).
  mnem(.iEndTry(V),Pc,Lbls,Lts,Lcs,Lns) where Tgt ?= findLevel(Lbls,V) => ([.intgr(26),.intgr(Tgt)],Pc+1,Lts,Lns).
  mnem(.iTryRslt(V),Pc,Lbls,Lts,Lcs,Lns) where Tgt ?= findLevel(Lbls,V) => ([.intgr(27),.intgr(Tgt)],Pc+1,Lts,Lns).
  mnem(.iThrow,Pc,Lbls,Lts,Lcs,Lns) => ([.intgr(28)],Pc+1,Lts,Lns).
  ...
  mnem(.iSav,Pc,Lbls,Lts,Lcs,Lns) => ([.intgr(40)],Pc+1,Lts,Lns).
  mnem(.iLdSav(V),Pc,Lbls,Lts,Lcs,Lns) where Tgt ?= findLevel(Lbls,V) => ([.intgr(41),.intgr(Tgt)],Pc+1,Lts,Lns).
  mnem(.iTstSav,Pc,Lbls,Lts,Lcs,Lns) => ([.intgr(42)],Pc+1,Lts,Lns).
  ...
  public opcodeHash = 1963412853981848296.
}
