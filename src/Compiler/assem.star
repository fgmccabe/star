star.compiler.assem{
  ...
  mnem([iLdG(U,al(V)),..Ins],Code,Lbls,Lts,Lns,Lcs,Pc,MxLcl,Ends) => mnem(Ins,Code++[intgr(31),strg(U),intgr(Tgt-Pc-5)],Lbls,Lts,Lns,Lcs,Pc+5,MxLcl,Ends).
  ...
  mnem([.iThGet(al(V)),..Ins],Code,Lbls,Lts,Lns,Lcs,Pc,MxLcl,Ends) where Tgt ^= Lbls[V] => mnem(Ins,Code++[intgr(35),intgr(Tgt-Pc-3)],Lbls,Lt1,Lns,Lcs,Pc+3,MxLcl,Ends).
