star.compiler.dependencies{
  ...
  collectTermRefs(A,All,Rf) where (_,L,E,H) ?= isTryHandle(A) =>
    collectTermRefs(H,All,collectTypeRefs(E,All,collectTermRefs(L,All,Rf))).
  ...
  collectDoRefs(A,All,Rf) where (_,L,E,H) ?= isTryHandle(A) =>
    collectTermRefs(H,All,collectTypeRefs(E,All,collectDoRefs(L,All,Rf))).
