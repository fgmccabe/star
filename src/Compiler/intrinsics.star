star.compiler.intrinsics{
  ...
  intrinsic(Es) => case Es in {
    ...
    "_int_div" => .some((.tpExp(.tpExp(.tpFun("=>",2),.tupleType([intType,intType])),intType),.iIDiv, .true, .notLast)).  -- divide two integers
    "_int_mod" => .some((.tpExp(.tpExp(.tpFun("=>",2),.tupleType([intType,intType])),intType),.iIMod, .true, .notLast)).  -- modulo remainder
    ...
    "_flt_div" => .some((.tpExp(.tpExp(.tpFun("=>",2),.tupleType([fltType,fltType])),fltType),.iFDiv, .true, .notLast)).  -- divide two floats
    "_flt_mod" => .some((.tpExp(.tpExp(.tpFun("=>",2),.tupleType([fltType,fltType])),fltType),.iFMod, .true, .notLast)).  -- modulo remainder
    ...
    "_flt_eq" => .some((.tpExp(.tpExp(.tpFun("=>",2),.tupleType([fltType,fltType,fltType])),boolType),.iFEq, .false, .notLast)).  -- float equality
    ...
    "_fiber_eq" => .some((.allType(.nomnal("s"),.allType(.nomnal("r"),.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.tpExp(.tpExp(.tpFun("star.core*fiber",2),.nomnal("r")),.nomnal("s")),.tpExp(.tpExp(.tpFun("star.core*fiber",2),.nomnal("r")),.nomnal("s"))])),boolType))),.iTEq, .true, .notLast)).  -- compare two fiber identifiers
    "_new_fiber" => .some((.allType(.nomnal("s"),.allType(.nomnal("r"),.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.tpExp(.tpExp(.tpFun("star.core*fiber",2),.nomnal("r")),.nomnal("s")),.nomnal("r")])),.nomnal("s"))])),.tpExp(.tpExp(.tpFun("star.core*fiber",2),.nomnal("r")),.nomnal("s"))))),.iFiber, .true, .notLast)).  -- create a new fiber
    "_spawn" => .some((.allType(.nomnal("s"),.allType(.nomnal("r"),.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.tpExp(.tpExp(.tpFun("star.core*fiber",2),.nomnal("r")),.nomnal("s"))])),.nomnal("s"))])),.nomnal("s")))),.iSpawn, .true, .notLast)).  -- spawn a new task
    "_suspend" => .some((.allType(.nomnal("s"),.allType(.nomnal("r"),.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.tpExp(.tpExp(.tpFun("star.core*fiber",2),.nomnal("r")),.nomnal("s")),.nomnal("s")])),.nomnal("r")))),.iSuspend, .true, .notLast)).  -- suspend a fiber
    "_retire" => .some((.allType(.nomnal("s"),.allType(.nomnal("r"),.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.tpExp(.tpExp(.tpFun("star.core*fiber",2),.nomnal("r")),.nomnal("s")),.nomnal("s")])),.tupleType([])))),.iRetire, .false, .noMore)).  -- retire a fiber
    "_resume" => .some((.allType(.nomnal("s"),.allType(.nomnal("r"),.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.tpExp(.tpExp(.tpFun("star.core*fiber",2),.nomnal("r")),.nomnal("s")),.nomnal("r")])),.nomnal("s")))),.iResume, .true, .notLast)).  -- resume a fiber
