star.compiler.intrinsics{
  ...
  intrinsic(Es) => case Es in {
    ...
    "_fiber_eq" => ? (allType(nomnal("s"),allType(nomnal("r"),tpExp(tpExp(tpFun("=>",2),tupleType([tpExp(tpFun("star.core*fiber",2),nomnal("s")),nomnal("r"),tpExp(tpFun("star.core*fiber",2),nomnal("s")),nomnal("r")])),boolType))),.iTEq, .true).  -- compare two fiber identifiers
    "_new_fiber" => ? (allType(nomnal("s"),allType(nomnal("r"),tpExp(tpExp(tpFun("=>",2),tupleType([tpExp(tpExp(tpFun("=>",2),tupleType([tpExp(tpFun("star.core*fiber",2),nomnal("s")),nomnal("r")])),nomnal("s"))])),tpExp(tpFun("star.core*fiber",2),nomnal("s"))))),.iFiber, .true).  -- create a new fiber
    "_suspend_fiber" => ? (allType(nomnal("s"),allType(nomnal("r"),tpExp(tpExp(tpFun("=>",2),tupleType([tpExp(tpFun("star.core*fiber",2),nomnal("s")),nomnal("r"),nomnal("s")])),nomnal("r")))),.iSuspend, .true).  -- suspend a fiber
    "_retire_fiber" => ? (allType(nomnal("s"),allType(nomnal("r"),tpExp(tpExp(tpFun("=>",2),tupleType([tpExp(tpFun("star.core*fiber",2),nomnal("s")),nomnal("r"),nomnal("s")])),tupleType([])))),.iRetire, .false).  -- retire a fiber
    "_resume_fiber" => ? (allType(nomnal("s"),allType(nomnal("r"),tpExp(tpExp(tpFun("=>",2),tupleType([tpExp(tpFun("star.core*fiber",2),nomnal("s")),nomnal("r"),nomnal("r")])),nomnal("s")))),.iResume, .true).  -- resume a fiber
