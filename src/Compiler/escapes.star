...
star.compiler.escapes{
  ...
  escapeType(Es) => case Es in {
    ...
    | "_int_div" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("integer"),.nomnal("integer")])),.nomnal("integer")),.raisEs(.nomnal("star.core*errorCode"))))
    | "_int_mod" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("integer"),.nomnal("integer")])),.nomnal("integer")),.raisEs(.nomnal("star.core*errorCode"))))
    | "_int_hash" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("integer")])),.nomnal("integer")))
    | "_int_gcd" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("integer"),.nomnal("integer")])),.nomnal("integer")),.raisEs(.nomnal("star.core*errorCode"))))
    | "_int_lg2" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("integer")])),.nomnal("integer")),.raisEs(.nomnal("star.core*errorCode"))))
    ...
    | "_flt_div" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("float"),.nomnal("float")])),.nomnal("float")),.raisEs(.nomnal("star.core*errorCode"))))
    | "_flt_mod" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("float"),.nomnal("float")])),.nomnal("float")),.raisEs(.nomnal("star.core*errorCode"))))
    ...
    | "_int_pow" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("integer"),.nomnal("integer")])),.nomnal("integer")),.raisEs(.nomnal("star.core*errorCode"))))
    ...
    | "_big_div" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("bigint"),.nomnal("bigint")])),.tupleType([.nomnal("bigint"),.nomnal("bigint")])),.raisEs(.nomnal("star.core*errorCode"))))
    ...
    | "_big_gcd" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("bigint"),.nomnal("bigint")])),.nomnal("bigint")),.raisEs(.nomnal("star.core*errorCode"))))
    ...
    | "_big2int" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("bigint")])),.tpExp(.tpFun("star.core*option",1),.nomnal("integer"))))
    | "_ints2big" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.tpExp(.tpFun("star.core*cons",1),.nomnal("integer"))])),.nomnal("bigint")))
    | "_big2ints" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("bigint")])),.tpExp(.tpFun("star.core*cons",1),.nomnal("integer"))))
    | "_str2big" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string")])),.tpExp(.tpFun("star.core*option",1),.nomnal("bigint"))))
    | "_big2str" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("bigint")])),.nomnal("string")))
    | "_big_format" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("bigint"),.nomnal("string")])),.nomnal("string")),.raisEs(.nomnal("star.core*errorCode"))))
    ...
    | "sqrt" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("float")])),.nomnal("float")),.raisEs(.nomnal("star.core*errorCode"))))
    | "exp" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("float")])),.nomnal("float")),.raisEs(.nomnal("star.core*errorCode"))))
    ...
    | "_futureIsResolved" => .some(.allType(.kVar("f"),.allType(.kVar("e"),.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.tpExp(.tpExp(.tpFun("future",2),.kVar("f")),.kVar("e"))])),.nomnal("boolean")))))
    | "_futureIsAccepted" => .some(.allType(.kVar("f"),.allType(.kVar("e"),.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.tpExp(.tpExp(.tpFun("future",2),.kVar("f")),.kVar("e"))])),.nomnal("boolean")))))
    | "_futureIsRejected" => .some(.allType(.kVar("f"),.allType(.kVar("e"),.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.tpExp(.tpExp(.tpFun("future",2),.kVar("f")),.kVar("e"))])),.nomnal("boolean")))))
    ...
    | "_tuple_nth" => .some(.allType(.kVar("t"),.allType(.kVar("e"),.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.kVar("t"),.nomnal("integer")])),.kVar("e")))))
    | "_tuple_set_nth" => .some(.allType(.kVar("t"),.allType(.kVar("e"),.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.kVar("t"),.nomnal("integer"),.kVar("e")])),.kVar("t")))))
    | "_cwd" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([])),.nomnal("string")))
    | "_cd" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string")])),.tupleType([])),.raisEs(.nomnal("star.core*errorCode"))))
    | "_rm" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string")])),.tupleType([])),.raisEs(.nomnal("star.core*errorCode"))))
    | "_mv" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string"),.nomnal("string")])),.tupleType([])),.raisEs(.nomnal("star.core*errorCode"))))
    | "_mkdir" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string"),.nomnal("integer")])),.tupleType([])),.raisEs(.nomnal("star.core*errorCode"))))
    | "_rmdir" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string")])),.tupleType([])),.raisEs(.nomnal("star.core*errorCode"))))
    | "_isdir" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string")])),.nomnal("boolean")))
    | "_file_chmod" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string"),.nomnal("integer")])),.tupleType([])),.raisEs(.nomnal("star.core*errorCode"))))
    | "_ls" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string")])),.tpExp(.tpFun("star.core*cons",1),.nomnal("string"))),.raisEs(.nomnal("star.core*errorCode"))))
    | "_repo" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([])),.nomnal("string")))
    | "_file_mode" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string")])),.nomnal("integer")),.raisEs(.nomnal("star.core*errorCode"))))
    | "_file_present" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string")])),.nomnal("boolean")))
    | "_file_type" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string")])),.nomnal("integer")),.raisEs(.nomnal("star.core*errorCode"))))
    | "_file_size" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string")])),.nomnal("integer")),.raisEs(.nomnal("star.core*errorCode"))))
    | "_file_modified" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string")])),.nomnal("integer")),.raisEs(.nomnal("star.core*errorCode"))))
    | "_file_date" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string")])),.tupleType([.nomnal("integer"),.nomnal("integer"),.nomnal("integer")])),.raisEs(.nomnal("star.core*errorCode"))))
    | "_openInFile" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string"),.nomnal("integer")])),.nomnal("ioHandle")),.raisEs(.nomnal("star.core*errorCode"))))
    | "_openOutFile" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string"),.nomnal("integer")])),.nomnal("ioHandle")),.raisEs(.nomnal("star.core*errorCode"))))
    | "_openAppendFile" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string"),.nomnal("integer")])),.nomnal("ioHandle")),.raisEs(.nomnal("star.core*errorCode"))))
    | "_openAppendIOFile" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string"),.nomnal("integer")])),.nomnal("ioHandle")),.raisEs(.nomnal("star.core*errorCode"))))
    | "_popen" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string"),.tpExp(.tpFun("star.core*cons",1),.nomnal("string")),.tpExp(.tpFun("star.core*cons",1),.tupleType([.nomnal("string"),.nomnal("string")]))])),.tupleType([.nomnal("ioHandle"),.nomnal("ioHandle"),.nomnal("ioHandle")])),.raisEs(.nomnal("star.core*errorCode"))))
    ...
    | "_inchars" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("ioHandle"),.nomnal("integer")])),.nomnal("string")),.raisEs(.nomnal("star.core*errorCode"))))
    | "_inchars_async" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("ioHandle"),.nomnal("integer")])),.tpExp(.tpExp(.tpFun("future",2),.nomnal("string")),.nomnal("star.core*errorCode"))),.raisEs(.nomnal("star.core*errorCode"))))
    | "_inchar" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("ioHandle")])),.nomnal("char")),.raisEs(.nomnal("star.core*errorCode"))))
    | "_inchar_async" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("ioHandle")])),.tpExp(.tpExp(.tpFun("future",2),.nomnal("char")),.nomnal("star.core*errorCode"))),.raisEs(.nomnal("star.core*errorCode"))))
    | "_inbyte" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("ioHandle")])),.nomnal("integer")),.raisEs(.nomnal("star.core*errorCode"))))
    | "_inbyte_async" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("ioHandle")])),.tpExp(.tpExp(.tpFun("future",2),.nomnal("integer")),.nomnal("star.core*errorCode"))),.raisEs(.nomnal("star.core*errorCode"))))
    | "_inbytes" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("ioHandle"),.nomnal("integer")])),.tpExp(.tpFun("star.vector*vect",1),.nomnal("integer"))),.raisEs(.nomnal("star.core*errorCode"))))
    | "_inbytes_async" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("ioHandle"),.nomnal("integer")])),.tpExp(.tpExp(.tpFun("future",2),.tpExp(.tpFun("star.vector*vect",1),.nomnal("integer"))),.nomnal("star.core*errorCode"))),.raisEs(.nomnal("star.core*errorCode"))))
    | "_inline" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("ioHandle")])),.nomnal("string")),.raisEs(.nomnal("star.core*errorCode"))))
    | "_inline_async" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("ioHandle")])),.tpExp(.tpExp(.tpFun("future",2),.nomnal("string")),.nomnal("star.core*errorCode"))),.raisEs(.nomnal("star.core*errorCode"))))
    | "_outchar" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("ioHandle"),.nomnal("char")])),.tupleType([])),.raisEs(.nomnal("star.core*errorCode"))))
    | "_outchar_async" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("ioHandle"),.nomnal("char")])),.tpExp(.tpExp(.tpFun("future",2),.tupleType([])),.nomnal("star.core*errorCode"))),.raisEs(.nomnal("star.core*errorCode"))))
    | "_outbyte" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("ioHandle"),.nomnal("integer")])),.tupleType([])),.raisEs(.nomnal("star.core*errorCode"))))
    | "_outbyte_async" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("ioHandle"),.nomnal("integer")])),.tpExp(.tpExp(.tpFun("future",2),.tupleType([])),.nomnal("star.core*errorCode"))),.raisEs(.nomnal("star.core*errorCode"))))
    | "_outbytes" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("ioHandle"),.tpExp(.tpFun("star.core*cons",1),.nomnal("integer"))])),.tupleType([])),.raisEs(.nomnal("star.core*errorCode"))))
    | "_outtext" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("ioHandle"),.nomnal("string")])),.tupleType([])),.raisEs(.nomnal("star.core*errorCode"))))
    | "_outtext_async" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("ioHandle"),.nomnal("string")])),.tpExp(.tpExp(.tpFun("future",2),.tupleType([])),.nomnal("star.core*errorCode"))),.raisEs(.nomnal("star.core*errorCode"))))
    ...
    | "_fseek" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("ioHandle"),.nomnal("integer")])),.tupleType([])),.raisEs(.nomnal("star.core*errorCode"))))
    ...
    | "_waitIo" => .some(.allType(.kVar("e"),.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.tpExp(.tpFun("star.core*cons",1),.tupleType([.nomnal("ioHandle"),.tpExp(.tpExp(.tpFun("=>",2),.tupleType([])),.nomnal("boolean")),.kVar("e")])),.nomnal("integer")])),.nomnal("boolean"))))
    | "_setfileencoding" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("ioHandle"),.nomnal("integer")])),.tupleType([])))
    | "_get_file" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string")])),.nomnal("string")),.raisEs(.nomnal("star.core*errorCode"))))
    | "_put_file" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string"),.nomnal("string")])),.tupleType([])),.raisEs(.nomnal("star.core*errorCode"))))
    | "_show" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string")])),.tupleType([])))
    | "_install_pkg" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string")])),.tpExp(.tpFun("star.core*cons",1),.tupleType([.nomnal("string"),.nomnal("string")]))),.raisEs(.nomnal("star.core*errorCode"))))
    | "_pkg_is_present" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string"),.nomnal("string")])),.nomnal("boolean")),.raisEs(.nomnal("star.core*errorCode"))))
    | "_in_manifest" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string"),.nomnal("string"),.nomnal("string")])),.nomnal("boolean")),.raisEs(.nomnal("star.core*errorCode"))))
    | "_locate_in_manifest" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string"),.nomnal("string"),.nomnal("string")])),.nomnal("string")),.raisEs(.nomnal("star.core*errorCode"))))
    ...
    | "_connect" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string"),.nomnal("integer"),.nomnal("integer")])),.tupleType([.nomnal("ioHandle"),.nomnal("ioHandle")])),.raisEs(.nomnal("star.core*errorCode"))))
    | "_listen" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("integer")])),.nomnal("ioHandle")),.raisEs(.nomnal("star.core*errorCode"))))
    | "_accept" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("ioHandle")])),.tupleType([.nomnal("ioHandle"),.nomnal("ioHandle"),.nomnal("string"),.nomnal("integer"),.nomnal("string")])),.raisEs(.nomnal("star.core*errorCode"))))
    | "_hosttoip" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string")])),.tpExp(.tpFun("star.core*cons",1),.nomnal("string"))))
    | "_iptohost" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string")])),.nomnal("string")),.raisEs(.nomnal("star.core*errorCode"))))
    | "_delay" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("float")])),.tupleType([])),.raisEs(.nomnal("star.core*errorCode"))))
    | "_sleep" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("float")])),.tupleType([])),.raisEs(.nomnal("star.core*errorCode"))))
    ...
    | "_formattime" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("float"),.nomnal("string")])),.nomnal("string")),.raisEs(.nomnal("star.core*errorCode"))))
    | "_parsetime" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string"),.nomnal("string")])),.tpExp(.tpFun("star.core*option",1),.nomnal("float"))))
    ...
    | "_digitCode" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("char")])),.nomnal("integer")),.raisEs(.nomnal("star.core*errorCode"))))
    ...
    | "_int_format" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("integer"),.nomnal("string")])),.nomnal("string")),.raisEs(.nomnal("star.core*errorCode"))))
    | "_flt_format" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("float"),.nomnal("string")])),.nomnal("string")))
    | "_str2flt" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string")])),.tpExp(.tpFun("star.core*option",1),.nomnal("float"))))
    | "_str2int" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string")])),.tpExp(.tpFun("star.core*option",1),.nomnal("integer"))))
    ...
    | "_stringOf" => .some(.allType(.kVar("t"),.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.kVar("t"),.nomnal("integer")])),.nomnal("string"))))
    | "_explode" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string")])),.tpExp(.tpFun("star.core*cons",1),.nomnal("char"))))
    | "_implode" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.tpExp(.tpFun("star.core*cons",1),.nomnal("char"))])),.nomnal("string")))
    ...
    | "_str_multicat" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.tpExp(.tpFun("star.core*cons",1),.nomnal("string"))])),.nomnal("string")))
    | "_str_hdtl" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string")])),.tpExp(.tpFun("star.core*option",1),.tupleType([.nomnal("char"),.nomnal("string")]))))
    | "_str_back" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string")])),.tupleType([.nomnal("string"),.nomnal("char")])),.raisEs(.nomnal("star.core*errorCode"))))
    ...
    | "_str_charat" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string"),.nomnal("integer")])),.tpExp(.tpFun("star.core*option",1),.nomnal("char"))))
    ...
    | "_getenv" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string")])),.tpExp(.tpFun("star.core*option",1),.nomnal("string"))))
    | "_setenv" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string"),.nomnal("string")])),.tupleType([])),.raisEs(.nomnal("star.core*errorCode"))))
    | "_envir" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([])),.tpExp(.tpFun("star.core*cons",1),.tupleType([.nomnal("string"),.nomnal("string")]))))
    ...
    | "_shell" => .some(.constrainedType(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("string"),.tpExp(.tpFun("star.core*cons",1),.nomnal("string")),.tpExp(.tpFun("star.core*cons",1),.tupleType([.nomnal("string"),.nomnal("string")]))])),.nomnal("integer")),.raisEs(.nomnal("star.core*errorCode"))))
