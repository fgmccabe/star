star.compiler.escapes{
  ...
  escapeType(Es) => case Es in {
    ...
    | "sqrt" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("float")])),.tpExp(.tpExp(.tpFun("result",2),.nomnal("float")),.nomnal("errorCode"))))
    | "exp" => .some(.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.nomnal("float")])),.tpExp(.tpExp(.tpFun("result",2),.nomnal("float")),.nomnal("errorCode"))))
