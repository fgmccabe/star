star.compiler.escapes{
  ...
  escapeType(Es) => case Es in {
    ...
    | "_get_file" => .some(.tpExp(.tpExp(.tpExp(.tpFun("=>",3),.tupleType([.nomnal("string"),.nomnal("integer")])),.nomnal("string")),.nomnal("errorCode")))
    | "_put_file" => .some(.tpExp(.tpExp(.tpExp(.tpFun("=>",3),.tupleType([.nomnal("string"),.nomnal("integer"),.nomnal("string")])),.tupleType([])),.nomnal("errorCode")))
