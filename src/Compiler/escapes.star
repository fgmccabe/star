...
star.compiler.escapes{
  ...
  escapeType("_str2big") => some(tpExp(tpExp(tpFun("=>",2),tplType([nomnal("star.core*string")])),nomnal("star.core*bigint"))).
  ...
  isEscape("_big_hash") => some(34).
  isEscape("_big_eq") => some(35).
  isEscape("_big_lt") => some(36).
  isEscape("_big_ge") => some(37).
  isEscape("_int2big") => some(38).
  isEscape("_ints2big") => some(39).
  isEscape("_big2ints") => some(40).
  isEscape("_str2big") => some(41).
  isEscape("_big2str") => some(42).
  isEscape("sqrt") => some(43).
  isEscape("exp") => some(44).
  isEscape("log") => some(45).
  isEscape("log10") => some(46).
  isEscape("pi") => some(47).
  isEscape("sin") => some(48).
  isEscape("cos") => some(49).
  isEscape("tan") => some(50).
  isEscape("asin") => some(51).
  isEscape("acos") => some(52).
  isEscape("atan") => some(53).
  isEscape("trunc") => some(54).
  isEscape("floor") => some(55).
  isEscape("ceil") => some(56).
  isEscape("integral") => some(57).
  isEscape("_irand") => some(58).
  isEscape("_random") => some(59).
  isEscape("_seed") => some(60).
  isEscape("_ldexp") => some(61).
  isEscape("_frexp") => some(62).
  isEscape("_modf") => some(63).
  isEscape("_band") => some(64).
  isEscape("_bor") => some(65).
  isEscape("_bxor") => some(66).
  isEscape("_blsl") => some(67).
  isEscape("_blsr") => some(68).
  isEscape("_basr") => some(69).
  isEscape("_bnot") => some(70).
  isEscape("_cell") => some(71).
  isEscape("_get") => some(72).
  isEscape("_assign") => some(73).
  isEscape("_overwrite") => some(74).
  isEscape("_tuple_nth") => some(75).
  isEscape("_tuple_set_nth") => some(76).
  isEscape("_cwd") => some(77).
  isEscape("_cd") => some(78).
  isEscape("_rm") => some(79).
  isEscape("_mv") => some(80).
  isEscape("_mkdir") => some(81).
  isEscape("_rmdir") => some(82).
  isEscape("_isdir") => some(83).
  isEscape("_file_chmod") => some(84).
  isEscape("_ls") => some(85).
  isEscape("_repo") => some(86).
  isEscape("_file_mode") => some(87).
  isEscape("_file_present") => some(88).
  isEscape("_file_type") => some(89).
  isEscape("_file_size") => some(90).
  isEscape("_file_modified") => some(91).
  isEscape("_file_date") => some(92).
  isEscape("_openInFile") => some(93).
  isEscape("_openOutFile") => some(94).
  isEscape("_openAppendFile") => some(95).
  isEscape("_openAppendIOFile") => some(96).
  isEscape("_popen") => some(97).
  isEscape("_close") => some(98).
  isEscape("_end_of_file") => some(99).
  isEscape("_ready_to_read") => some(100).
  isEscape("_ready_to_write") => some(101).
  isEscape("_inchars") => some(102).
  isEscape("_inchar") => some(103).
  isEscape("_inbyte") => some(104).
  isEscape("_inline") => some(105).
  isEscape("_intext") => some(106).
  isEscape("_outchar") => some(107).
  isEscape("_outbyte") => some(108).
  isEscape("_outbytes") => some(109).
  isEscape("_outtext") => some(110).
  isEscape("_stdfile") => some(111).
  isEscape("_fposition") => some(112).
  isEscape("_fseek") => some(113).
  isEscape("_flush") => some(114).
  isEscape("_flushall") => some(115).
  isEscape("_setfileencoding") => some(116).
  isEscape("_get_file") => some(117).
  isEscape("_put_file") => some(118).
  isEscape("_show") => some(119).
  isEscape("_install_pkg") => some(120).
  isEscape("_pkg_is_present") => some(121).
  isEscape("_in_manifest") => some(122).
  isEscape("_locate_in_manifest") => some(123).
  isEscape("_logmsg") => some(124).
  isEscape("_connect") => some(125).
  isEscape("_listen") => some(126).
  isEscape("_accept") => some(127).
  isEscape("_hosttoip") => some(128).
  isEscape("_iptohost") => some(129).
  isEscape("_delay") => some(130).
  isEscape("_sleep") => some(131).
  isEscape("_now") => some(132).
  isEscape("_today") => some(133).
  isEscape("_ticks") => some(134).
  isEscape("_time2date") => some(135).
  isEscape("_time2utc") => some(136).
  isEscape("_date2time") => some(137).
  isEscape("_utc2time") => some(138).
  isEscape("_uniCodeCategory") => some(139).
  isEscape("_isCcChar") => some(140).
  isEscape("_isCfChar") => some(141).
  isEscape("_isCnChar") => some(142).
  isEscape("_isCoChar") => some(143).
  isEscape("_isCsChar") => some(144).
  isEscape("_isLlChar") => some(145).
  isEscape("_isLmChar") => some(146).
  isEscape("_isLoChar") => some(147).
  isEscape("_isLtChar") => some(148).
  isEscape("_isLuChar") => some(149).
  isEscape("_isMcChar") => some(150).
  isEscape("_isMeChar") => some(151).
  isEscape("_isMnChar") => some(152).
  isEscape("_isNdChar") => some(153).
  isEscape("_isNlChar") => some(154).
  isEscape("_isNoChar") => some(155).
  isEscape("_isPcChar") => some(156).
  isEscape("_isPdChar") => some(157).
  isEscape("_isPeChar") => some(158).
  isEscape("_isPfChar") => some(159).
  isEscape("_isPiChar") => some(160).
  isEscape("_isPoChar") => some(161).
  isEscape("_isPsChar") => some(162).
  isEscape("_isScChar") => some(163).
  isEscape("_isSkChar") => some(164).
  isEscape("_isSmChar") => some(165).
  isEscape("_isSoChar") => some(166).
  isEscape("_isZlChar") => some(167).
  isEscape("_isZpChar") => some(168).
  isEscape("_isZsChar") => some(169).
  isEscape("_isLetterChar") => some(170).
  isEscape("_digitCode") => some(171).
  isEscape("_codePoint") => some(172).
  isEscape("_char") => some(173).
  isEscape("_isIDStart") => some(174).
  isEscape("_isIDContinue") => some(175).
  isEscape("_int2str") => some(176).
  isEscape("_flt2str") => some(177).
  isEscape("_int_format") => some(178).
  isEscape("_flt_format") => some(179).
  isEscape("_str2flt") => some(180).
  isEscape("_str2int") => some(181).
  isEscape("_chr_eq") => some(182).
  isEscape("_chr_lt") => some(183).
  isEscape("_chr_ge") => some(184).
  isEscape("_chr_hash") => some(185).
  isEscape("_chr_quote") => some(186).
  isEscape("_chr_format") => some(187).
  isEscape("_str_eq") => some(188).
  isEscape("_str_lt") => some(189).
  isEscape("_str_ge") => some(190).
  isEscape("_str_hash") => some(191).
  isEscape("_str_len") => some(192).
  isEscape("_str_gen") => some(193).
  isEscape("_stringOf") => some(194).
  isEscape("_explode") => some(195).
  isEscape("_implode") => some(196).
  isEscape("_str_find") => some(197).
  isEscape("_sub_str") => some(198).
  isEscape("_str_split") => some(199).
  isEscape("_str_concat") => some(200).
  isEscape("_str_reverse") => some(201).
  isEscape("_str_start") => some(202).
  isEscape("_str_splice") => some(203).
  isEscape("_str_multicat") => some(204).
  isEscape("_str_hdtl") => some(205).
  isEscape("_str_back") => some(206).
  isEscape("_str_cons") => some(207).
  isEscape("_code2str") => some(208).
  isEscape("_str_apnd") => some(209).
  isEscape("_str_quote") => some(210).
  isEscape("_str_format") => some(211).
  isEscape("_getenv") => some(212).
  isEscape("_setenv") => some(213).
  isEscape("_envir") => some(214).
  isEscape("_getlogin") => some(215).
  isEscape("_fork") => some(216).
  isEscape("_thread") => some(217).
  isEscape("_kill") => some(218).
  isEscape("_thread_state") => some(219).
  isEscape("_waitfor") => some(220).
  isEscape("_shell") => some(221).
  isEscape("_newLock") => some(222).
  isEscape("_acquireLock") => some(223).
  isEscape("_waitLock") => some(224).
  isEscape("_releaseLock") => some(225).
  isEscape("_ins_debug") => some(226).
  isEscape("_stackTrace") => some(227).
