...
star.compiler.escapes{
  ...
  isEscape("_ints2big") => some(40).
  isEscape("_big2ints") => some(41).
  isEscape("_str2big") => some(42).
  isEscape("_big2str") => some(43).
  isEscape("sqrt") => some(44).
  isEscape("exp") => some(45).
  isEscape("log") => some(46).
  isEscape("log10") => some(47).
  isEscape("pi") => some(48).
  isEscape("sin") => some(49).
  isEscape("cos") => some(50).
  isEscape("tan") => some(51).
  isEscape("asin") => some(52).
  isEscape("acos") => some(53).
  isEscape("atan") => some(54).
  isEscape("trunc") => some(55).
  isEscape("floor") => some(56).
  isEscape("ceil") => some(57).
  isEscape("integral") => some(58).
  isEscape("_irand") => some(59).
  isEscape("_random") => some(60).
  isEscape("_seed") => some(61).
  isEscape("_ldexp") => some(62).
  isEscape("_frexp") => some(63).
  isEscape("_modf") => some(64).
  isEscape("_band") => some(65).
  isEscape("_bor") => some(66).
  isEscape("_bxor") => some(67).
  isEscape("_blsl") => some(68).
  isEscape("_blsr") => some(69).
  isEscape("_basr") => some(70).
  isEscape("_bnot") => some(71).
  isEscape("_cell") => some(72).
  isEscape("_get") => some(73).
  isEscape("_assign") => some(74).
  isEscape("_overwrite") => some(75).
  isEscape("_tuple_nth") => some(76).
  isEscape("_tuple_set_nth") => some(77).
  isEscape("_cwd") => some(78).
  isEscape("_cd") => some(79).
  isEscape("_rm") => some(80).
  isEscape("_mv") => some(81).
  isEscape("_mkdir") => some(82).
  isEscape("_rmdir") => some(83).
  isEscape("_isdir") => some(84).
  isEscape("_file_chmod") => some(85).
  isEscape("_ls") => some(86).
  isEscape("_repo") => some(87).
  isEscape("_file_mode") => some(88).
  isEscape("_file_present") => some(89).
  isEscape("_file_type") => some(90).
  isEscape("_file_size") => some(91).
  isEscape("_file_modified") => some(92).
  isEscape("_file_date") => some(93).
  isEscape("_openInFile") => some(94).
  isEscape("_openOutFile") => some(95).
  isEscape("_openAppendFile") => some(96).
  isEscape("_openAppendIOFile") => some(97).
  isEscape("_popen") => some(98).
  isEscape("_close") => some(99).
  isEscape("_end_of_file") => some(100).
  isEscape("_ready_to_read") => some(101).
  isEscape("_ready_to_write") => some(102).
  isEscape("_inchars") => some(103).
  isEscape("_inchar") => some(104).
  isEscape("_inbyte") => some(105).
  isEscape("_inline") => some(106).
  isEscape("_intext") => some(107).
  isEscape("_outchar") => some(108).
  isEscape("_outbyte") => some(109).
  isEscape("_outbytes") => some(110).
  isEscape("_outtext") => some(111).
  isEscape("_stdfile") => some(112).
  isEscape("_fposition") => some(113).
  isEscape("_fseek") => some(114).
  isEscape("_flush") => some(115).
  isEscape("_flushall") => some(116).
  isEscape("_setfileencoding") => some(117).
  isEscape("_get_file") => some(118).
  isEscape("_put_file") => some(119).
  isEscape("_show") => some(120).
  isEscape("_install_pkg") => some(121).
  isEscape("_pkg_is_present") => some(122).
  isEscape("_in_manifest") => some(123).
  isEscape("_locate_in_manifest") => some(124).
  isEscape("_logmsg") => some(125).
  isEscape("_connect") => some(126).
  isEscape("_listen") => some(127).
  isEscape("_accept") => some(128).
  isEscape("_hosttoip") => some(129).
  isEscape("_iptohost") => some(130).
  isEscape("_delay") => some(131).
  isEscape("_sleep") => some(132).
  isEscape("_now") => some(133).
  isEscape("_today") => some(134).
  isEscape("_ticks") => some(135).
  isEscape("_time2date") => some(136).
  isEscape("_time2utc") => some(137).
  isEscape("_date2time") => some(138).
  isEscape("_utc2time") => some(139).
  isEscape("_uniCodeCategory") => some(140).
  isEscape("_isCcChar") => some(141).
  isEscape("_isCfChar") => some(142).
  isEscape("_isCnChar") => some(143).
  isEscape("_isCoChar") => some(144).
  isEscape("_isCsChar") => some(145).
  isEscape("_isLlChar") => some(146).
  isEscape("_isLmChar") => some(147).
  isEscape("_isLoChar") => some(148).
  isEscape("_isLtChar") => some(149).
  isEscape("_isLuChar") => some(150).
  isEscape("_isMcChar") => some(151).
  isEscape("_isMeChar") => some(152).
  isEscape("_isMnChar") => some(153).
  isEscape("_isNdChar") => some(154).
  isEscape("_isNlChar") => some(155).
  isEscape("_isNoChar") => some(156).
  isEscape("_isPcChar") => some(157).
  isEscape("_isPdChar") => some(158).
  isEscape("_isPeChar") => some(159).
  isEscape("_isPfChar") => some(160).
  isEscape("_isPiChar") => some(161).
  isEscape("_isPoChar") => some(162).
  isEscape("_isPsChar") => some(163).
  isEscape("_isScChar") => some(164).
  isEscape("_isSkChar") => some(165).
  isEscape("_isSmChar") => some(166).
  isEscape("_isSoChar") => some(167).
  isEscape("_isZlChar") => some(168).
  isEscape("_isZpChar") => some(169).
  isEscape("_isZsChar") => some(170).
  isEscape("_isLetterChar") => some(171).
  isEscape("_digitCode") => some(172).
  isEscape("_codePoint") => some(173).
  isEscape("_char") => some(174).
  isEscape("_isIDStart") => some(175).
  isEscape("_isIDContinue") => some(176).
  isEscape("_int2str") => some(177).
  isEscape("_flt2str") => some(178).
  isEscape("_int_format") => some(179).
  isEscape("_flt_format") => some(180).
  isEscape("_str2flt") => some(181).
  isEscape("_str2int") => some(182).
  isEscape("_chr_eq") => some(183).
  isEscape("_chr_lt") => some(184).
  isEscape("_chr_ge") => some(185).
  isEscape("_chr_hash") => some(186).
  isEscape("_chr_quote") => some(187).
  isEscape("_chr_format") => some(188).
  isEscape("_str_eq") => some(189).
  isEscape("_str_lt") => some(190).
  isEscape("_str_ge") => some(191).
  isEscape("_str_hash") => some(192).
  isEscape("_str_len") => some(193).
  isEscape("_str_gen") => some(194).
  isEscape("_stringOf") => some(195).
  isEscape("_explode") => some(196).
  isEscape("_implode") => some(197).
  isEscape("_str_find") => some(198).
  isEscape("_sub_str") => some(199).
  isEscape("_str_split") => some(200).
  isEscape("_str_concat") => some(201).
  isEscape("_str_reverse") => some(202).
  isEscape("_str_start") => some(203).
  isEscape("_str_splice") => some(204).
  isEscape("_str_multicat") => some(205).
  isEscape("_str_hdtl") => some(206).
  isEscape("_str_back") => some(207).
  isEscape("_str_cons") => some(208).
  isEscape("_code2str") => some(209).
  isEscape("_str_apnd") => some(210).
  isEscape("_str_quote") => some(211).
  isEscape("_str_format") => some(212).
  isEscape("_getenv") => some(213).
  isEscape("_setenv") => some(214).
  isEscape("_envir") => some(215).
  isEscape("_getlogin") => some(216).
  isEscape("_fork") => some(217).
  isEscape("_thread") => some(218).
  isEscape("_kill") => some(219).
  isEscape("_thread_state") => some(220).
  isEscape("_waitfor") => some(221).
  isEscape("_shell") => some(222).
  isEscape("_newLock") => some(223).
  isEscape("_acquireLock") => some(224).
  isEscape("_waitLock") => some(225).
  isEscape("_releaseLock") => some(226).
  isEscape("_ins_debug") => some(227).
  isEscape("_stackTrace") => some(228).
