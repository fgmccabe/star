star.compiler.escapes{
  ...
  escapeType(Es) => case Es in {
    ...
    | "_date2time" => .some(.funType(.tupleType([.tupleType([.nomnal("integer"),.nomnal("integer"),.nomnal("integer"),.nomnal("integer"),.nomnal("integer"),.nomnal("float"),.nomnal("integer")])]),.nomnal("float"),.voidType))
    | "_utc2time" => .some(.funType(.tupleType([.tupleType([.nomnal("integer"),.nomnal("integer"),.nomnal("integer"),.nomnal("integer"),.nomnal("integer"),.nomnal("float"),.nomnal("integer")])]),.nomnal("float"),.voidType))
