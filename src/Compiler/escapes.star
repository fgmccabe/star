star.compiler.escapes{
  ...
  escapeType(Es) => case Es in {
    ...
    | "_int2flt" => .some(.funType(.tupleType([.nomnal("integer")]),.nomnal("float"),.voidType))
    | "_flt2int" => .some(.funType(.tupleType([.nomnal("float")]),.nomnal("integer"),.voidType))
    ...
    | "_big2int" => .some(.funType(.tupleType([.nomnal("bigint")]),.tpExp(.tpFun("option",1),.nomnal("integer")),.voidType))
    ...
    | "_str2big" => .some(.funType(.tupleType([.nomnal("string")]),.tpExp(.tpFun("option",1),.nomnal("bigint")),.voidType))
    ...
    | "sqrt" => .some(.funType(.tupleType([.nomnal("float")]),.nomnal("float"),.nomnal("errorCode")))
    | "exp" => .some(.funType(.tupleType([.nomnal("float")]),.nomnal("float"),.nomnal("errorCode")))
    | "log" => .some(.funType(.tupleType([.nomnal("float")]),.nomnal("float"),.voidType))
    | "log10" => .some(.funType(.tupleType([.nomnal("float")]),.nomnal("float"),.voidType))
    ...
    | "_parsetime" => .some(.funType(.tupleType([.nomnal("string"),.nomnal("string")]),.tpExp(.tpFun("option",1),.nomnal("float")),.voidType))
    ...
    | "_str2flt" => .some(.funType(.tupleType([.nomnal("string")]),.tpExp(.tpFun("option",1),.nomnal("float")),.voidType))
    | "_str2int" => .some(.funType(.tupleType([.nomnal("string")]),.tpExp(.tpFun("option",1),.nomnal("integer")),.voidType))
    ...
    | "_str_charat" => .some(.funType(.tupleType([.nomnal("string"),.nomnal("integer")]),.tpExp(.tpFun("option",1),.nomnal("char")),.voidType))
