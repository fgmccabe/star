...
star.compiler.escapes{
  ...
  escapeType(Es) => case Es in {
    ...
    | "_abort" => .some(.allType(.kVar("a"),.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.kVar("a"),.nomnal("star.core*string")])),.tupleType([]))))
    ...
    | "_fiber_eq" => .some(.allType(.kVar("r"),.allType(.kVar("s"),.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.tpExp(.tpExp(.tpFun("fiber",2),.kVar("r")),.kVar("s")),.tpExp(.tpExp(.tpFun("fiber",2),.kVar("r")),.kVar("s"))])),.nomnal("star.core*boolean")))))
    ...
    | "_futureIsResolved" => .some(.allType(.kVar("f"),.allType(.kVar("e"),.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.tpExp(.tpExp(.tpFun("future",2),.kVar("f")),.kVar("e"))])),.nomnal("star.core*boolean")))))
    | "_futureIsAccepted" => .some(.allType(.kVar("f"),.allType(.kVar("e"),.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.tpExp(.tpExp(.tpFun("future",2),.kVar("f")),.kVar("e"))])),.nomnal("star.core*boolean")))))
    | "_futureIsRejected" => .some(.allType(.kVar("f"),.allType(.kVar("e"),.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.tpExp(.tpExp(.tpFun("future",2),.kVar("f")),.kVar("e"))])),.nomnal("star.core*boolean")))))
    ...
    | "_tuple_nth" => .some(.allType(.kVar("t"),.allType(.kVar("e"),.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.kVar("t"),.nomnal("star.core*integer")])),.kVar("e")))))
    | "_tuple_set_nth" => .some(.allType(.kVar("t"),.allType(.kVar("e"),.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.kVar("t"),.nomnal("star.core*integer"),.kVar("e")])),.kVar("t")))))
    ...
    | "_waitIo" => .some(.allType(.kVar("e"),.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.tpExp(.tpFun("star.core*cons",1),.tupleType([.nomnal("ioHandle"),.tpExp(.tpExp(.tpFun("=>",2),.tupleType([])),.nomnal("star.core*boolean")),.kVar("e")])),.nomnal("star.core*integer")])),.nomnal("star.core*boolean"))))
    ...
    | "_stringOf" => .some(.allType(.kVar("t"),.tpExp(.tpExp(.tpFun("=>",2),.tupleType([.kVar("t"),.nomnal("star.core*integer")])),.nomnal("star.core*string"))))
