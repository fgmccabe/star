...
infixOp(":",1249,1250,1249,"type declaration/annotation",True)
...
infixOp("throws",949,950,949,"can throw an exception",True)
...
prefixOp("collect",300,299,"build a sequence from an action expression",True)
prefixOp("?",300,299,"pull value",False)
infixOp("?",299,300,299,"option match",False)
prefixOp("??",950,949,"pull together a failable cexpression",False)
token("generator","define a generator expression or type",True)
token("void","define a void keyword, never legal",True)
token("unreachable","unreachable is always fatal",True)
...
infixOp("suspend",898,899,898,"suspend task",True)
infixOp("retire",898,899,898,"retire task",True)
infixOp("resume",898,899,898,"resume task",True)
prefixOp("suspend",899,898,"suspend task",True)
prefixOp("retire",899,898,"retire task",True)
infixOp("=",974,975,974,"definition",True)
infixOp(":=",974,975,974,"assignment",False)
infixOp("<-",974,975,974,"monadic valof",True)
...
infixOp("?|",960,960,959,"optional conditional",False)
...
infixOp("+=",719,720,719,"increment",False)
infixOp("-=",719,720,719,"decrement",False)
...
prefixOp("elemis",930,929,"element of built sequence",True)
prefixOp("throw",230,229,"throw an exception",True)
...
bracket("/../","/.","./","",2000,"regexp expression")
