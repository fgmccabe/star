...
infixOp(":",1249,1250,1249,"type declaration",True)
...
prefixOp("?",300,299,"extract value from either/or",False)
...
infixOp("^",149,150,149,"option hat",False)
prefixOp("^",150,149,"pull",False)
