...
infixOp(";",1899,1900,1900,"sequencing operator")
...
infixOp("<~",1230,1231,1230,"type interface rule")
infixOp("~>",1230,1231,1230,"type function")
...
infixOp("=",974,975,974,"definition")
infixOp(":=",974,975,974,"reassignable variable definition")
infixOp(";;",949,950,950,"grammar sequencing operator")
infixOp("=>",949,950,950,"function arrow")
infixOp(">>=",949,950,950,"monadic bind")
infixOp(">>",949,950,950,"monadic bind")
infixOp("<*>",949,950,950,"applicative splat")
...
prefixOp("^^",300,299,"wrap value as special parser")
prefixOp("pure",300,299,"wrap value in applicative")
prefixOp("return",300,299,"wrap value in monad")
prefixOp("raise",300,299,"error return in monad")
lastPreOp
