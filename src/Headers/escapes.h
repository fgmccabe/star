...
escape(_bcount,True,False,"F(i)i","count the number of bits set")
...
escape(_overwrite,True,False,":k't'F(k't'k't')k't'","overwrite a structure with new structure")
...
escape(_tuple_set_nth,True,False,":k't':k'e'F(k't'ik'e')k't'","Update tuple element")
