...
escape(_sqrt, throws(flt, flt, ERR), "square root")
escape(_exp, throws(flt, flt, ERR), "exponential")
...
escape(_date2time, func(tpl(int int int int int flt int), flt), "convert a date to a time")
escape(_utc2time, func(tpl(int int int int int flt int), flt), "convert a UTC date to a time")
