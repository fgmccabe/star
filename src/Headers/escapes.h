...
escape(_list_empty,":k't'F(Lk't')l","is the list empty")
escape(_list_size,":k't'F(Lk't')i","compute the size of a list")
escape(_list_nth,":k't'F(Lk't'i)k't'","access element of a list")
escape(_list_append,":k't'F(Lk't'k't')Lk't'","append element to a list")
escape(_list_prepend,":k't'F(Lk't'k't')Lk't'","prepend element to a list")
escape(_list_insert,":k't'F(Lk't'ik't')Lk't'","insert element into a list")
escape(_list_replace,":k't'F(Lk't'ik't')Lk't'","replace element in a list")
escape(_list_remove,":k't'F(Lk't'i)Lk't'","remove element from a list")
escape(_list_slice,":k't'F(Lk't'ii)Lk't'","slice a list")
escape(_list_front,":k't'F(Lk't'i)Lk't'","front portion of list")
escape(_list_back,":k't'F(Lk't'i)Lk't'","back portion of list")
escape(_list_nil,":k't'F(i)Lk't'","create an empty list of min capacity")
escape(_list_concat,":k't'F(Lk't'Lk't')Lk't'","concatenate two lists")
escape(_list_flatten,":k't'F(LLk't')Lk't'","flatten a list of lists into a list")
escape(_list_reverse,":k't'F(Lk't')Lk't'","reverse the elements of a list")
...
*/
  ...
  escape(_ls,"F(S)LS","return a list of files in a directory")
