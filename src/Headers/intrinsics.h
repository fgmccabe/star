...
intrinsic(_suspend_fiber,":k's':k'r'F("fiberType("k'r'","k's'")"k's')k'r'","Suspend", True,NotLast,"suspend a fiber")
intrinsic(_retire_fiber,":k's':k'r'F("fiberType("k'r'","k's'")"k's')()","Retire",False,Last,"retire a fiber")
intrinsic(_resume_fiber,":k's':k'r'F("fiberType("k'r'","k's'")"k'r')k's'","Resume" ,True,NotLast,"resume a fiber")
