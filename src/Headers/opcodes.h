...
typedef enum {
    ...
    Break = 14,            // leave block
    Result = 15,            // return value out of block
    Loop = 16,            // jump back to start of block
    Drop = 17,            // drop top of stack
    Dup = 18,            // duplicate top of stack
...
#define OPCODE_SIGNATURE 964331819850886512
#endif
