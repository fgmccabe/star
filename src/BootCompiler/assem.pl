...
mnem([iDrop|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[18|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iRst(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[19,V|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iFiber|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[20|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iSuspend|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[21|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iResume|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[22|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iRetire|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[23|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iUnderflow|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[24|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iLdV|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[25|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iLdC(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[26,LtNo|M],Cdx) :-
      Pc1 is Pc+1,
      findLit(Lt,V,LtNo,Lt1),
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iLd(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[27,Off|M],Cdx) :-
      Pc1 is Pc+1,
      findLocal(V,LsMap,Off),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iSt(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[28,Off|M],Cdx) :-
      Pc1 is Pc+1,
      findLocal(V,LsMap,Off),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iStV(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[29,Off|M],Cdx) :-
      Pc1 is Pc+1,
      findLocal(V,LsMap,Off),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iTee(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[30,Off|M],Cdx) :-
      Pc1 is Pc+1,
      findLocal(V,LsMap,Off),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iLdG(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[31,V|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iStG(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[32,V|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iTG(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[33,V|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iSav|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[34|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iLdSav(W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[35,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iTstSav|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[36|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iStSav|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[37|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iTSav|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[38|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iCell|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[39|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iGet|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[40|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iAssign|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[41|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iCLbl(V,W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[42,LtNo,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLit(Lt,V,LtNo,Lt1),
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iCInt(V,W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[43,LtNo,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLit(Lt,V,LtNo,Lt1),
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iCChar(V,W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[44,LtNo,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLit(Lt,V,LtNo,Lt1),
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iCFlt(V,W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[45,LtNo,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLit(Lt,V,LtNo,Lt1),
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iCLit(V,W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[46,LtNo,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLit(Lt,V,LtNo,Lt1),
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iNth(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[47,V|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iStNth(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[48,V|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iIf(W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[49,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iIfNot(W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[50,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iICase(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[51,V|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iCase(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[52,V|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iIxCase(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[53,V|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iIAdd|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[54|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iISub|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[55|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iIMul|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[56|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iIDiv(W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[57,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iIMod(W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[58,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iIAbs|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[59|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iIEq|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[60|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iILt|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[61|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iIGe|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[62|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iCEq|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[63|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iCLt|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[64|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iCGe|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[65|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iBAnd|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[66|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iBOr|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[67|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iBXor|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[68|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iBLsl|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[69|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iBLsr|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[70|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iBAsr|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[71|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iBNot|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[72|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iFAdd|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[73|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iFSub|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[74|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iFMul|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[75|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iFDiv(W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[76,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iFMod(W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[77,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iFAbs|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[78|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iFEq|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[79|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iFLt|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[80|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iFGe|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[81|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iAlloc(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[82,LtNo|M],Cdx) :-
      Pc1 is Pc+1,
      findLit(Lt,V,LtNo,Lt1),
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iClosure(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[83,LtNo|M],Cdx) :-
      Pc1 is Pc+1,
      findLit(Lt,V,LtNo,Lt1),
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iFrame(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[84,V|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iLine(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[85,LtNo|M],Cdx) :-
      Pc1 is Pc+1,
      findLit(Lt,V,LtNo,Lt1),
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iBind(V,W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[86,LtNo,Off|M],Cdx) :-
      Pc1 is Pc+1,
      findLit(Lt,V,LtNo,Lt1),
      findLocal(W,LsMap,Off),
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iDBug(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[87,LtNo|M],Cdx) :-
      Pc1 is Pc+1,
      findLit(Lt,V,LtNo,Lt1),
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
...
opcodeHash(1472534314864623738).
