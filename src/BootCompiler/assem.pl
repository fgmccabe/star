...
stackHwm([iValof(_,W)|Ins],CH0,H0,Hwm) :-
  stackHwm(W,CH0,H0,H1),
  stackHwm(Ins,CH0,H1,Hwm).
...
stackHwm([iLdC(_)|Ins],CH0,H0,Hwm) :-
  ...
  (CH1>H0 -> H1 = CH1 ; H1 = H0),
  stackHwm(Ins,CH1,H1,Hwm).
stackHwm([iLd(_)|Ins],CH0,H0,Hwm) :-
  CH1 is CH0+1,
  (CH1>H0 -> H1 = CH1 ; H1 = H0),
  stackHwm(Ins,CH1,H1,Hwm).
stackHwm([iSt(_)|Ins],CH0,H0,Hwm) :-
  CH1 is CH0-1,
  (CH1>H0 -> H1 = CH1 ; H1 = H0),
  stackHwm(Ins,CH1,H1,Hwm).
stackHwm([iStV(_)|Ins],CH0,H0,Hwm) :-
  stackHwm(Ins,CH0,H0,Hwm).
stackHwm([iTee(_)|Ins],CH0,H0,Hwm) :-
  stackHwm(Ins,CH0,H0,Hwm).
...
stackHwm([iCLbl(_,_)|Ins],CH0,H0,Hwm) :-
  ...
  (CH1>H0 -> H1 = CH1 ; H1 = H0),
  stackHwm(Ins,CH1,H1,Hwm).
stackHwm([iCInt(_,_)|Ins],CH0,H0,Hwm) :-
  CH1 is CH0-1,
  (CH1>H0 -> H1 = CH1 ; H1 = H0),
  stackHwm(Ins,CH1,H1,Hwm).
stackHwm([iCChar(_,_)|Ins],CH0,H0,Hwm) :-
  CH1 is CH0-1,
  (CH1>H0 -> H1 = CH1 ; H1 = H0),
  stackHwm(Ins,CH1,H1,Hwm).
stackHwm([iCFlt(_,_)|Ins],CH0,H0,Hwm) :-
  CH1 is CH0-1,
  (CH1>H0 -> H1 = CH1 ; H1 = H0),
  stackHwm(Ins,CH1,H1,Hwm).
...
stackHwm([iIfNot(_)|Ins],CH0,H0,Hwm) :-
  ...
  (CH1>H0 -> H1 = CH1 ; H1 = H0),
  stackHwm(Ins,CH1,H1,Hwm).
stackHwm([iICase(_)|Ins],CH0,H0,Hwm) :-
  CH1 is CH0-1,
  (CH1>H0 -> H1 = CH1 ; H1 = H0),
  stackHwm(Ins,CH1,H1,Hwm).
stackHwm([iCase(_)|Ins],CH0,H0,Hwm) :-
  ...
  (CH1>H0 -> H1 = CH1 ; H1 = H0),
  stackHwm(Ins,CH1,H1,Hwm).
stackHwm([iIxCase(_)|Ins],CH0,H0,Hwm) :-
  CH1 is CH0-1,
  (CH1>H0 -> H1 = CH1 ; H1 = H0),
  stackHwm(Ins,CH1,H1,Hwm).
...
stackHwm([iIMul|Ins],CH0,H0,Hwm) :-
  ...
  (CH1>H0 -> H1 = CH1 ; H1 = H0),
  stackHwm(Ins,CH1,H1,Hwm).
stackHwm([iIDiv(_)|Ins],CH0,H0,Hwm) :-
  CH1 is CH0-2,
  (CH1>H0 -> H1 = CH1 ; H1 = H0),
  stackHwm(Ins,CH1,H1,Hwm).
stackHwm([iIMod(_)|Ins],CH0,H0,Hwm) :-
  CH1 is CH0-2,
  (CH1>H0 -> H1 = CH1 ; H1 = H0),
  stackHwm(Ins,CH1,H1,Hwm).
...
stackHwm([iFMul|Ins],CH0,H0,Hwm) :-
  ...
  (CH1>H0 -> H1 = CH1 ; H1 = H0),
  stackHwm(Ins,CH1,H1,Hwm).
stackHwm([iFDiv(_)|Ins],CH0,H0,Hwm) :-
  CH1 is CH0-1,
  (CH1>H0 -> H1 = CH1 ; H1 = H0),
  stackHwm(Ins,CH1,H1,Hwm).
stackHwm([iFMod(_)|Ins],CH0,H0,Hwm) :-
  CH1 is CH0-1,
  (CH1>H0 -> H1 = CH1 ; H1 = H0),
  stackHwm(Ins,CH1,H1,Hwm).
...
stackHwm([iLine(_)|Ins],CH0,H0,Hwm) :-
  stackHwm(Ins,CH0,H0,Hwm).
stackHwm([iBind(_,_)|Ins],CH0,H0,Hwm) :-
  stackHwm(Ins,CH0,H0,Hwm).
stackHwm([iDBug(_)|Ins],CH0,H0,Hwm) :-
  stackHwm(Ins,CH0,H0,Hwm).
...
localHwm([iValof(_,W)|Ins],C0,Cx,H0,Hwm) :-
  localHwm(W,C0,C1,H0,H1),
  localHwm(Ins,C1,Cx,H1,Hwm).
localHwm([iBreak(_)|Ins],C0,Cx,H0,Hwm) :-
  localHwm(Ins,C0,Cx,H0,Hwm).
localHwm([iResult(_)|Ins],C0,Cx,H0,Hwm) :-
  localHwm(Ins,C0,Cx,H0,Hwm).
...
localHwm([iLdC(_)|Ins],C0,Cx,H0,Hwm) :-
  localHwm(Ins,C0,Cx,H0,Hwm).
localHwm([iLd(V)|Ins],C0,Cx,H0,Hwm) :-
  countLocal(V,C0,C1,H0,H1),
  localHwm(Ins,C1,Cx,H1,Hwm).
localHwm([iSt(V)|Ins],C0,Cx,H0,Hwm) :-
  countLocal(V,C0,C1,H0,H1),
  localHwm(Ins,C1,Cx,H1,Hwm).
localHwm([iStV(V)|Ins],C0,Cx,H0,Hwm) :-
  countLocal(V,C0,C1,H0,H1),
  localHwm(Ins,C1,Cx,H1,Hwm).
localHwm([iTee(V)|Ins],C0,Cx,H0,Hwm) :-
  countLocal(V,C0,C1,H0,H1),
  localHwm(Ins,C1,Cx,H1,Hwm).
...
localHwm([iCLbl(_,_)|Ins],C0,Cx,H0,Hwm) :-
  localHwm(Ins,C0,Cx,H0,Hwm).
localHwm([iCInt(_,_)|Ins],C0,Cx,H0,Hwm) :-
  localHwm(Ins,C0,Cx,H0,Hwm).
localHwm([iCChar(_,_)|Ins],C0,Cx,H0,Hwm) :-
  localHwm(Ins,C0,Cx,H0,Hwm).
localHwm([iCFlt(_,_)|Ins],C0,Cx,H0,Hwm) :-
  localHwm(Ins,C0,Cx,H0,Hwm).
...
localHwm([iIfNot(_)|Ins],C0,Cx,H0,Hwm) :-
  localHwm(Ins,C0,Cx,H0,Hwm).
localHwm([iICase(_)|Ins],C0,Cx,H0,Hwm) :-
  localHwm(Ins,C0,Cx,H0,Hwm).
localHwm([iCase(_)|Ins],C0,Cx,H0,Hwm) :-
  localHwm(Ins,C0,Cx,H0,Hwm).
localHwm([iIxCase(_)|Ins],C0,Cx,H0,Hwm) :-
  localHwm(Ins,C0,Cx,H0,Hwm).
...
localHwm([iIMul|Ins],C0,Cx,H0,Hwm) :-
  localHwm(Ins,C0,Cx,H0,Hwm).
localHwm([iIDiv(_)|Ins],C0,Cx,H0,Hwm) :-
  localHwm(Ins,C0,Cx,H0,Hwm).
localHwm([iIMod(_)|Ins],C0,Cx,H0,Hwm) :-
  localHwm(Ins,C0,Cx,H0,Hwm).
...
localHwm([iFMul|Ins],C0,Cx,H0,Hwm) :-
  localHwm(Ins,C0,Cx,H0,Hwm).
localHwm([iFDiv(_)|Ins],C0,Cx,H0,Hwm) :-
  localHwm(Ins,C0,Cx,H0,Hwm).
localHwm([iFMod(_)|Ins],C0,Cx,H0,Hwm) :-
  localHwm(Ins,C0,Cx,H0,Hwm).
...
localHwm([iFrame(_)|Ins],C0,Cx,H0,Hwm) :-
  localHwm(Ins,C0,Cx,H0,Hwm).
localHwm([iLine(_)|Ins],C0,Cx,H0,Hwm) :-
  localHwm(Ins,C0,Cx,H0,Hwm).
localHwm([iBind(_,W)|Ins],C0,Cx,H0,Hwm) :-
  countLocal(W,C0,C1,H0,H1),
  localHwm(Ins,C1,Cx,H1,Hwm).
localHwm([iDBug(_)|Ins],C0,Cx,H0,Hwm) :-
  localHwm(Ins,C0,Cx,H0,Hwm).
...
mnem([iAbort(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[1,LtNo|M],Cdx) :-
      ...
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iCall(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[2,LtNo|M],Cdx) :-
      Pc1 is Pc+1,
      findLit(Lt,V,LtNo,Lt1),
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iOCall(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[3,V|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iEscape(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[4,V|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iXCall(V,W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[5,LtNo,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLit(Lt,V,LtNo,Lt1),
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iXOCall(V,W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[6,V,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iXEscape(V,W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[7,V,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iTCall(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[8,LtNo|M],Cdx) :-
      Pc1 is Pc+1,
      findLit(Lt,V,LtNo,Lt1),
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iTOCall(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[9,V|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iEntry(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[10,V|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iRet|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[11|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iXRet|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[12|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iBlock(V,W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[13,V,B|M],Cdx) :-
      Pc1 is Pc+1,
      assemBlock(W,none,Lbls,Lt,Lt1,Pc1,Pc2,LsMap,B,[]),
      mnem(Ins,Lbls,Lt1,Ltx,Pc2,Pcx,LsMap,M,Cdx).
mnem([iValof(V,W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[14,V,B|M],Cdx) :-
      Pc1 is Pc+1,
      assemBlock(W,none,Lbls,Lt,Lt1,Pc1,Pc2,LsMap,B,[]),
      mnem(Ins,Lbls,Lt1,Ltx,Pc2,Pcx,LsMap,M,Cdx).
mnem([iBreak(W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[15,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iResult(W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[16,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iLoop(W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[17,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iDrop|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[18|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iRot(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[19,V|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iRst(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[20,V|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iFiber|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[21|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iSuspend|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[22|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iResume|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[23|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iRetire|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[24|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iUnderflow|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[25|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iLdV|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[26|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iLdC(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[27,LtNo|M],Cdx) :-
      Pc1 is Pc+1,
      findLit(Lt,V,LtNo,Lt1),
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iLd(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[28,Off|M],Cdx) :-
      Pc1 is Pc+1,
      findLocal(V,LsMap,Off),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iSt(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[29,Off|M],Cdx) :-
      Pc1 is Pc+1,
      findLocal(V,LsMap,Off),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iStV(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[30,Off|M],Cdx) :-
      Pc1 is Pc+1,
      findLocal(V,LsMap,Off),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iTee(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[31,Off|M],Cdx) :-
      Pc1 is Pc+1,
      findLocal(V,LsMap,Off),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iLdG(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[32,V|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iStG(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[33,V|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iTG(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[34,V|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iSav|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[35|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iLdSav(W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[36,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iTstSav|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[37|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iStSav|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[38|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iTSav|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[39|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iCell|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[40|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iGet|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[41|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iAssign|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[42|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iCLbl(V,W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[43,LtNo,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLit(Lt,V,LtNo,Lt1),
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iCInt(V,W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[44,LtNo,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLit(Lt,V,LtNo,Lt1),
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iCChar(V,W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[45,LtNo,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLit(Lt,V,LtNo,Lt1),
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iCFlt(V,W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[46,LtNo,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLit(Lt,V,LtNo,Lt1),
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iCLit(V,W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[47,LtNo,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLit(Lt,V,LtNo,Lt1),
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iNth(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[48,V|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iStNth(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[49,V|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iIf(W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[50,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iIfNot(W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[51,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iICase(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[52,V|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iCase(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[53,V|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iIxCase(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[54,V|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iIAdd|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[55|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iISub|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[56|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iIMul|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[57|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iIDiv(W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[58,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iIMod(W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[59,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iIAbs|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[60|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iIEq|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[61|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iILt|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[62|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iIGe|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[63|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iCEq|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[64|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iCLt|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[65|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iCGe|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[66|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iBAnd|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[67|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iBOr|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[68|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iBXor|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[69|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iBLsl|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[70|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iBLsr|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[71|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iBAsr|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[72|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iBNot|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[73|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iFAdd|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[74|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iFSub|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[75|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iFMul|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[76|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iFDiv(W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[77,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iFMod(W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[78,Lvl|M],Cdx) :-
      Pc1 is Pc+1,
      findLevel(W,Lbls,0,Lvl),
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iFAbs|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[79|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iFEq|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[80|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iFLt|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[81|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iFGe|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[82|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iAlloc(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[83,LtNo|M],Cdx) :-
      Pc1 is Pc+1,
      findLit(Lt,V,LtNo,Lt1),
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iClosure(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[84,LtNo|M],Cdx) :-
      Pc1 is Pc+1,
      findLit(Lt,V,LtNo,Lt1),
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iFrame(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[85,V|M],Cdx) :-
      Pc1 is Pc+1,
      mnem(Ins,Lbls,Lt,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iLine(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[86,LtNo|M],Cdx) :-
      Pc1 is Pc+1,
      findLit(Lt,V,LtNo,Lt1),
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iBind(V,W)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[87,LtNo,Off|M],Cdx) :-
      Pc1 is Pc+1,
      findLit(Lt,V,LtNo,Lt1),
      findLocal(W,LsMap,Off),
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
mnem([iDBug(V)|Ins],Lbls,Lt,Ltx,Pc,Pcx,LsMap,[88,LtNo|M],Cdx) :-
      Pc1 is Pc+1,
      findLit(Lt,V,LtNo,Lt1),
      mnem(Ins,Lbls,Lt1,Ltx,Pc1,Pcx,LsMap,M,Cdx).
...
showMnem(iBlock(U,V),Pc,sq([PcDx,ss(": "),ss("Block"), ss(" "), UU, ss(","), VV])) :- !,
  ...
  true.
showMnem(iValof(U,V),Pc,sq([PcDx,ss(": "),ss("Valof"), ss(" "), UU, ss(","), VV])) :- !,
  showPc(Pc,PcDx),
  UU=ix(U),
  blockPc(Pc,SPc),
  showMnems(V, SPc, Ms),
...
showMnem(iBreak(V),Pc,sq([PcDx,ss(": "),ss("Break"), ss(","), VV])) :- !,
  ...
  VV=ss(V),!,
  true.
showMnem(iResult(V),Pc,sq([PcDx,ss(": "),ss("Result"), ss(","), VV])) :- !,
  showPc(Pc,PcDx),
  VV=ss(V),!,
  true.
...
showMnem(iLdC(U),Pc,sq([PcDx,ss(": "),ss("LdC"), ss(" "), UU])) :- !,
  ...
  ssTrm(U,0,UU),
  true.
showMnem(iLd(U),Pc,sq([PcDx,ss(": "),ss("Ld"), ss(" "), UU])) :- !,
  showPc(Pc,PcDx),
  UU=ss(U),
  true.
showMnem(iSt(U),Pc,sq([PcDx,ss(": "),ss("St"), ss(" "), UU])) :- !,
  showPc(Pc,PcDx),
  UU=ss(U),
  true.
showMnem(iStV(U),Pc,sq([PcDx,ss(": "),ss("StV"), ss(" "), UU])) :- !,
  ...
  UU=ss(U),
  true.
showMnem(iTee(U),Pc,sq([PcDx,ss(": "),ss("Tee"), ss(" "), UU])) :- !,
  showPc(Pc,PcDx),
  UU=ss(U),
  true.
...
showMnem(iCLbl(U,V),Pc,sq([PcDx,ss(": "),ss("CLbl"), ss(" "), UU, ss(","), VV])) :- !,
  ...
  VV=ss(V),!,
  true.
showMnem(iCInt(U,V),Pc,sq([PcDx,ss(": "),ss("CInt"), ss(" "), UU, ss(","), VV])) :- !,
  showPc(Pc,PcDx),
  ssTrm(U,0,UU),
  VV=ss(V),!,
  true.
showMnem(iCChar(U,V),Pc,sq([PcDx,ss(": "),ss("CChar"), ss(" "), UU, ss(","), VV])) :- !,
  showPc(Pc,PcDx),
  ssTrm(U,0,UU),
  VV=ss(V),!,
  true.
showMnem(iCFlt(U,V),Pc,sq([PcDx,ss(": "),ss("CFlt"), ss(" "), UU, ss(","), VV])) :- !,
  showPc(Pc,PcDx),
  ssTrm(U,0,UU),
  VV=ss(V),!,
  true.
...
showMnem(iIfNot(V),Pc,sq([PcDx,ss(": "),ss("IfNot"), ss(" "), VV])) :- !,
  ...
  VV=ss(V),!,
  true.
showMnem(iICase(U),Pc,sq([PcDx,ss(": "),ss("ICase"), ss(" "), UU])) :- !,
  showPc(Pc,PcDx),
  UU=ix(U),
  true.
showMnem(iCase(U),Pc,sq([PcDx,ss(": "),ss("Case"), ss(" "), UU])) :- !,
  ...
  UU=ix(U),
  true.
showMnem(iIxCase(U),Pc,sq([PcDx,ss(": "),ss("IxCase"), ss(" "), UU])) :- !,
  showPc(Pc,PcDx),
  UU=ix(U),
  true.
...
showMnem(iIMul,Pc,sq([PcDx,ss(": "),ss("IMul")])) :- !,
  showPc(Pc,PcDx),
  true.
showMnem(iIDiv(V),Pc,sq([PcDx,ss(": "),ss("IDiv"), ss(" "), VV])) :- !,
  showPc(Pc,PcDx),
  VV=ss(V),!,
  true.
showMnem(iIMod(V),Pc,sq([PcDx,ss(": "),ss("IMod"), ss(" "), VV])) :- !,
  showPc(Pc,PcDx),
  VV=ss(V),!,
  true.
...
showMnem(iFMul,Pc,sq([PcDx,ss(": "),ss("FMul")])) :- !,
  showPc(Pc,PcDx),
  true.
showMnem(iFDiv(V),Pc,sq([PcDx,ss(": "),ss("FDiv"), ss(" "), VV])) :- !,
  showPc(Pc,PcDx),
  VV=ss(V),!,
  true.
showMnem(iFMod(V),Pc,sq([PcDx,ss(": "),ss("FMod"), ss(" "), VV])) :- !,
  showPc(Pc,PcDx),
  VV=ss(V),!,
  true.
...
showMnem(iLine(U),Pc,sq([PcDx,ss(": "),ss("Line"), ss(" "), UU])) :- !,
  ...
  ssTrm(U,0,UU),
  true.
showMnem(iBind(U,V),Pc,sq([PcDx,ss(": "),ss("Bind"), ss(" "), UU, ss(","), VV])) :- !,
  showPc(Pc,PcDx),
  ssTrm(U,0,UU),
  VV=ss(V),
  true.
showMnem(iDBug(U),Pc,sq([PcDx,ss(": "),ss("dBug"), ss(" "), UU])) :- !,
  showPc(Pc,PcDx),
  ssTrm(U,0,UU),
  true.


opcodeHash(414122082387643854).
