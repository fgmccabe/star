...
isIntrinsic("_fiber_eq",allType(kVar("s"),allType(kVar("r"),funType(tplType([tpExp(tpExp(tpFun("star.core*fiber",2),kVar("r")),kVar("s")),tpExp(tpExp(tpFun("star.core*fiber",2),kVar("r")),kVar("s"))]),type("star.core*boolean")))),iTEq).  % compare two fiber identifiers
isIntrinsic("_new_fiber",allType(kVar("s"),allType(kVar("r"),funType(tplType([funType(tplType([tpExp(tpExp(tpFun("star.core*fiber",2),kVar("r")),kVar("s")),kVar("r")]),kVar("s"))]),tpExp(tpExp(tpFun("star.core*fiber",2),kVar("r")),kVar("s"))))),iFiber).  % create a new fiber
isIntrinsic("_spawn",allType(kVar("s"),allType(kVar("r"),funType(tplType([funType(tplType([tpExp(tpExp(tpFun("star.core*fiber",2),kVar("r")),kVar("s"))]),kVar("s"))]),kVar("s")))),iSpawn).  % spawn a new task
isIntrinsic("_suspend",allType(kVar("s"),allType(kVar("r"),funType(tplType([tpExp(tpExp(tpFun("star.core*fiber",2),kVar("r")),kVar("s")),kVar("s")]),kVar("r")))),iSuspend).  % suspend a fiber
isIntrinsic("_retire",allType(kVar("s"),allType(kVar("r"),funType(tplType([tpExp(tpExp(tpFun("star.core*fiber",2),kVar("r")),kVar("s")),kVar("s")]),tplType([])))),iRetire).  % retire a fiber
isIntrinsic("_resume",allType(kVar("s"),allType(kVar("r"),funType(tplType([tpExp(tpExp(tpFun("star.core*fiber",2),kVar("r")),kVar("s")),kVar("r")]),kVar("s")))),iResume).  % resume a fiber
