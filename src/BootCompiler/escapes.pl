...
isEscape("_uniCodeCategory",154).
isEscape("_isCcChar",155).
isEscape("_isCfChar",156).
isEscape("_isCnChar",157).
isEscape("_isCoChar",158).
isEscape("_isCsChar",159).
isEscape("_isLlChar",160).
isEscape("_isLmChar",161).
isEscape("_isLoChar",162).
isEscape("_isLtChar",163).
isEscape("_isLuChar",164).
isEscape("_isMcChar",165).
isEscape("_isMeChar",166).
isEscape("_isMnChar",167).
isEscape("_isNdChar",168).
isEscape("_isNlChar",169).
isEscape("_isNoChar",170).
isEscape("_isPcChar",171).
isEscape("_isPdChar",172).
isEscape("_isPeChar",173).
isEscape("_isPfChar",174).
isEscape("_isPiChar",175).
isEscape("_isPoChar",176).
isEscape("_isPsChar",177).
isEscape("_isScChar",178).
isEscape("_isSkChar",179).
isEscape("_isSmChar",180).
isEscape("_isSoChar",181).
isEscape("_isZlChar",182).
isEscape("_isZpChar",183).
isEscape("_isZsChar",184).
isEscape("_isLetterChar",185).
isEscape("_digitCode",186).
isEscape("_codePoint",187).
isEscape("_char",188).
isEscape("_isIDStart",189).
isEscape("_isIDContinue",190).
isEscape("_int2str",191).
isEscape("_flt2str",192).
isEscape("_int_format",193).
isEscape("_flt_format",194).
isEscape("_str2flt",195).
isEscape("_str2int",196).
isEscape("_chr_eq",197).
isEscape("_chr_lt",198).
isEscape("_chr_ge",199).
isEscape("_chr_hash",200).
isEscape("_chr_quote",201).
isEscape("_chr_format",202).
isEscape("_str_eq",203).
isEscape("_str_lt",204).
isEscape("_str_ge",205).
isEscape("_str_hash",206).
isEscape("_str_len",207).
isEscape("_str_gen",208).
isEscape("_stringOf",209).
isEscape("_explode",210).
isEscape("_implode",211).
isEscape("_str_find",212).
isEscape("_sub_str",213).
isEscape("_str_split",214).
isEscape("_str_concat",215).
isEscape("_str_reverse",216).
isEscape("_str_start",217).
isEscape("_str_splice",218).
isEscape("_str_multicat",219).
isEscape("_str_hdtl",220).
isEscape("_str_back",221).
isEscape("_str_cons",222).
isEscape("_code2str",223).
isEscape("_str_apnd",224).
isEscape("_str_quote",225).
isEscape("_str_format",226).
isEscape("_getenv",227).
isEscape("_setenv",228).
isEscape("_envir",229).
isEscape("_getlogin",230).
isEscape("_fork",231).
isEscape("_thread",232).
isEscape("_kill",233).
isEscape("_thread_state",234).
isEscape("_waitfor",235).
isEscape("_shell",236).
isEscape("_newLock",237).
isEscape("_acquireLock",238).
isEscape("_waitLock",239).
isEscape("_releaseLock",240).
isEscape("_ins_debug",241).
isEscape("_stackTrace",242).
