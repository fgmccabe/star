...
escapeType("_int_hash",funType(tplType([type("integer")]),type("integer"),voidType)).
...
escapeType("_flt_plus",funType(tplType([type("float"),type("float")]),type("float"),voidType)).
escapeType("_flt_minus",funType(tplType([type("float"),type("float")]),type("float"),voidType)).
escapeType("_flt_times",funType(tplType([type("float"),type("float")]),type("float"),voidType)).
...
escapeType("_int_abs",funType(tplType([type("integer")]),type("integer"),voidType)).
escapeType("_flt_abs",funType(tplType([type("float")]),type("float"),voidType)).
escapeType("_int_eq",funType(tplType([type("integer"),type("integer")]),type("boolean"),voidType)).
escapeType("_int_lt",funType(tplType([type("integer"),type("integer")]),type("boolean"),voidType)).
escapeType("_int_ge",funType(tplType([type("integer"),type("integer")]),type("boolean"),voidType)).
...
escapeType("_flt_pwr",funType(tplType([type("float"),type("float")]),type("float"),voidType)).
escapeType("_big_plus",funType(tplType([type("bigint"),type("bigint")]),type("bigint"),voidType)).
escapeType("_big_minus",funType(tplType([type("bigint"),type("bigint")]),type("bigint"),voidType)).
escapeType("_big_times",funType(tplType([type("bigint"),type("bigint")]),type("bigint"),voidType)).
escapeType("_big_div",funType(tplType([type("bigint"),type("bigint")]),tplType([type("bigint"),type("bigint")]),type("errorCode"))).
escapeType("_big_bitand",funType(tplType([type("bigint"),type("bigint")]),type("bigint"),voidType)).
escapeType("_big_bitor",funType(tplType([type("bigint"),type("bigint")]),type("bigint"),voidType)).
escapeType("_big_bitxor",funType(tplType([type("bigint"),type("bigint")]),type("bigint"),voidType)).
escapeType("_big_bitnot",funType(tplType([type("bigint")]),type("bigint"),voidType)).
escapeType("_big_gcd",funType(tplType([type("bigint"),type("bigint")]),type("bigint"),type("errorCode"))).
escapeType("_big_hash",funType(tplType([type("bigint")]),type("integer"),voidType)).
escapeType("_big_eq",funType(tplType([type("bigint"),type("bigint")]),type("boolean"),voidType)).
...
escapeType("tan",funType(tplType([type("float")]),type("float"),voidType)).
escapeType("asin",funType(tplType([type("float")]),type("float"),voidType)).
escapeType("acos",funType(tplType([type("float")]),type("float"),voidType)).
escapeType("atan",funType(tplType([type("float")]),type("float"),voidType)).
escapeType("trunc",funType(tplType([type("float")]),type("float"),voidType)).
escapeType("floor",funType(tplType([type("float")]),type("float"),voidType)).
escapeType("ceil",funType(tplType([type("float")]),type("float"),voidType)).
escapeType("integral",funType(tplType([type("float")]),type("boolean"),voidType)).
escapeType("_irand",funType(tplType([type("integer")]),type("integer"),voidType)).
escapeType("_random",funType(tplType([]),type("float"),voidType)).
escapeType("_seed",funType(tplType([type("integer")]),tplType([]),voidType)).
escapeType("_ldexp",funType(tplType([type("float"),type("integer")]),type("float"),voidType)).
escapeType("_frexp",funType(tplType([type("float")]),tplType([type("float"),type("integer")]),voidType)).
escapeType("_modf",funType(tplType([type("float")]),tplType([type("float"),type("integer")]),voidType)).
escapeType("_band",funType(tplType([type("integer"),type("integer")]),type("integer"),voidType)).
escapeType("_bor",funType(tplType([type("integer"),type("integer")]),type("integer"),voidType)).
escapeType("_bxor",funType(tplType([type("integer"),type("integer")]),type("integer"),voidType)).
escapeType("_blsl",funType(tplType([type("integer"),type("integer")]),type("integer"),voidType)).
escapeType("_blsr",funType(tplType([type("integer"),type("integer")]),type("integer"),voidType)).
escapeType("_basr",funType(tplType([type("integer"),type("integer")]),type("integer"),voidType)).
escapeType("_bnot",funType(tplType([type("integer")]),type("integer"),voidType)).
escapeType("_cell_future",allType(kVar("s"),allType(kVar("e"),funType(tplType([tpExp(tpFun("ref",1),tpExp(tpExp(tpFun("star.either*either",2),kVar("s")),kVar("e")))]),tpExp(tpExp(tpFun("future",2),kVar("s")),kVar("e")),voidType)))).
escapeType("_futureIsResolved",allType(kVar("a"),allType(kVar("e"),funType(tplType([tpExp(tpExp(tpFun("future",2),kVar("a")),kVar("e"))]),type("boolean"),voidType)))).
escapeType("_futureIsAccepted",allType(kVar("a"),allType(kVar("e"),funType(tplType([tpExp(tpExp(tpFun("future",2),kVar("a")),kVar("e"))]),type("boolean"),voidType)))).
escapeType("_futureIsRejected",allType(kVar("a"),allType(kVar("e"),funType(tplType([tpExp(tpExp(tpFun("future",2),kVar("a")),kVar("e"))]),type("boolean"),voidType)))).
...
escapeType("_cwd",funType(tplType([]),type("string"),voidType)).
...
escapeType("_isdir",funType(tplType([type("string")]),type("boolean"),voidType)).
...
escapeType("_repo",funType(tplType([]),type("string"),voidType)).
escapeType("_file_mode",funType(tplType([type("string")]),type("integer"),type("errorCode"))).
escapeType("_file_present",funType(tplType([type("string")]),type("boolean"),voidType)).
...
escapeType("_end_of_file",funType(tplType([type("ioHandle")]),type("boolean"),voidType)).
...
escapeType("_stdfile",funType(tplType([type("integer")]),type("ioHandle"),voidType)).
escapeType("_fposition",funType(tplType([type("ioHandle")]),type("integer"),voidType)).
...
escapeType("_flushall",funType(tplType([]),tplType([]),voidType)).
escapeType("_fname",funType(tplType([type("ioHandle")]),type("string"),voidType)).
escapeType("_waitIo",allType(kVar("e"),funType(tplType([tpExp(tpFun("cons",1),tplType([type("ioHandle"),funType(tplType([]),type("boolean"),voidType),kVar("e")])),type("integer")]),type("boolean"),voidType))).
escapeType("_setfileencoding",funType(tplType([type("ioHandle"),type("integer")]),tplType([]),voidType)).
...
escapeType("_show",funType(tplType([type("string")]),tplType([]),voidType)).
escapeType("_logmsg",funType(tplType([type("string")]),tplType([]),voidType)).
escapeType("_display_depth",funType(tplType([]),type("integer"),voidType)).
...
escapeType("_hosttoip",funType(tplType([type("string")]),tpExp(tpFun("cons",1),type("string")),voidType)).
...
escapeType("_now",funType(tplType([]),type("float"),voidType)).
escapeType("_today",funType(tplType([]),type("float"),voidType)).
...
escapeType("_isCnChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isCoChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isCsChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isLlChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isLmChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isLoChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isLtChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isLuChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isMcChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isMeChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isMnChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isNdChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isNlChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isNoChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isPcChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isPdChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isPeChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isPfChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isPiChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isPoChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isPsChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isScChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isSkChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isSmChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isSoChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isZlChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isZpChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isZsChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_isLetterChar",funType(tplType([type("char")]),type("boolean"),voidType)).
escapeType("_digitCode",funType(tplType([type("char")]),type("integer"),type("errorCode"))).
escapeType("_codePoint",funType(tplType([type("char")]),type("integer"),voidType)).
escapeType("_int2chr",funType(tplType([type("integer")]),type("char"),voidType)).
escapeType("_int2str",funType(tplType([type("integer")]),type("string"),voidType)).
...
escapeType("_chr_hash",funType(tplType([type("char")]),type("integer"),voidType)).
escapeType("_chr_quote",funType(tplType([type("char")]),type("string"),voidType)).
escapeType("_chr_format",funType(tplType([type("char"),type("string")]),type("string"),voidType)).
escapeType("_str_eq",funType(tplType([type("string"),type("string")]),type("boolean"),voidType)).
escapeType("_str_lt",funType(tplType([type("string"),type("string")]),type("boolean"),voidType)).
escapeType("_str_ge",funType(tplType([type("string"),type("string")]),type("boolean"),voidType)).
escapeType("_str_hash",funType(tplType([type("string")]),type("integer"),voidType)).
escapeType("_str_len",funType(tplType([type("string")]),type("integer"),voidType)).
escapeType("_str_gen",funType(tplType([type("string")]),type("string"),voidType)).
escapeType("_stringOf",allType(kVar("r"),funType(tplType([kVar("r"),type("integer")]),type("string"),voidType))).
escapeType("_explode",funType(tplType([type("string")]),tpExp(tpFun("cons",1),type("char")),voidType)).
escapeType("_implode",funType(tplType([tpExp(tpFun("cons",1),type("char"))]),type("string"),voidType)).
escapeType("_str_find",funType(tplType([type("string"),type("string"),type("integer")]),type("integer"),voidType)).
escapeType("_sub_str",funType(tplType([type("string"),type("integer"),type("integer")]),type("string"),voidType)).
escapeType("_str_split",funType(tplType([type("string"),type("integer")]),tplType([type("string"),type("string")]),voidType)).
escapeType("_str_concat",funType(tplType([type("string"),type("string")]),type("string"),voidType)).
escapeType("_str_reverse",funType(tplType([type("string")]),type("string"),voidType)).
escapeType("_str_start",funType(tplType([type("string"),type("string")]),type("boolean"),voidType)).
escapeType("_str_end",funType(tplType([type("string"),type("string")]),type("boolean"),voidType)).
escapeType("_str_splice",funType(tplType([type("string"),type("integer"),type("integer"),type("string")]),type("string"),voidType)).
escapeType("_str_multicat",funType(tplType([tpExp(tpFun("cons",1),type("string"))]),type("string"),voidType)).
escapeType("_str_hdtl",funType(tplType([type("string")]),tpExp(tpFun("option",1),tplType([type("char"),type("string")])),voidType)).
...
escapeType("_str_format",funType(tplType([type("string"),type("string")]),type("string"),voidType)).
...
escapeType("_break",prcType(tplType([type("string")]),voidType)).
