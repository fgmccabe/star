...
isEscape("_formattime",156).
isEscape("_parsetime",157).
isEscape("_uniCodeCategory",158).
isEscape("_isCcChar",159).
isEscape("_isCfChar",160).
isEscape("_isCnChar",161).
isEscape("_isCoChar",162).
isEscape("_isCsChar",163).
isEscape("_isLlChar",164).
isEscape("_isLmChar",165).
isEscape("_isLoChar",166).
isEscape("_isLtChar",167).
isEscape("_isLuChar",168).
isEscape("_isMcChar",169).
isEscape("_isMeChar",170).
isEscape("_isMnChar",171).
isEscape("_isNdChar",172).
isEscape("_isNlChar",173).
isEscape("_isNoChar",174).
isEscape("_isPcChar",175).
isEscape("_isPdChar",176).
isEscape("_isPeChar",177).
isEscape("_isPfChar",178).
isEscape("_isPiChar",179).
isEscape("_isPoChar",180).
isEscape("_isPsChar",181).
isEscape("_isScChar",182).
isEscape("_isSkChar",183).
isEscape("_isSmChar",184).
isEscape("_isSoChar",185).
isEscape("_isZlChar",186).
isEscape("_isZpChar",187).
isEscape("_isZsChar",188).
isEscape("_isLetterChar",189).
isEscape("_digitCode",190).
isEscape("_codePoint",191).
isEscape("_char",192).
isEscape("_isIDStart",193).
isEscape("_isIDContinue",194).
isEscape("_int2str",195).
isEscape("_flt2str",196).
isEscape("_int_format",197).
isEscape("_flt_format",198).
isEscape("_str2flt",199).
isEscape("_str2int",200).
isEscape("_chr_eq",201).
isEscape("_chr_lt",202).
isEscape("_chr_ge",203).
isEscape("_chr_hash",204).
isEscape("_chr_quote",205).
isEscape("_chr_format",206).
isEscape("_str_eq",207).
isEscape("_str_lt",208).
isEscape("_str_ge",209).
isEscape("_str_hash",210).
isEscape("_str_len",211).
isEscape("_str_gen",212).
isEscape("_stringOf",213).
isEscape("_explode",214).
isEscape("_implode",215).
isEscape("_str_find",216).
isEscape("_sub_str",217).
isEscape("_str_split",218).
isEscape("_str_concat",219).
isEscape("_str_reverse",220).
isEscape("_str_start",221).
isEscape("_str_end",222).
