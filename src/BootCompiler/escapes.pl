...
isEscape("_ints2big",40).
isEscape("_big2ints",41).
isEscape("_str2big",42).
isEscape("_big2str",43).
isEscape("sqrt",44).
isEscape("exp",45).
isEscape("log",46).
isEscape("log10",47).
...
isEscape("_get",73).
isEscape("_assign",74).
isEscape("_overwrite",75).
isEscape("_tuple_nth",76).
isEscape("_tuple_set_nth",77).
isEscape("_cwd",78).
isEscape("_cd",79).
isEscape("_rm",80).
isEscape("_mv",81).
...
isEscape("_rmdir",83).
isEscape("_isdir",84).
isEscape("_file_chmod",85).
isEscape("_ls",86).
isEscape("_repo",87).
isEscape("_file_mode",88).
isEscape("_file_present",89).
isEscape("_file_type",90).
isEscape("_file_size",91).
isEscape("_file_modified",92).
isEscape("_file_date",93).
isEscape("_openInFile",94).
isEscape("_openOutFile",95).
isEscape("_openAppendFile",96).
isEscape("_openAppendIOFile",97).
isEscape("_popen",98).
isEscape("_close",99).
isEscape("_end_of_file",100).
isEscape("_ready_to_read",101).
isEscape("_ready_to_write",102).
isEscape("_inchars",103).
isEscape("_inchar",104).
isEscape("_inbyte",105).
isEscape("_inline",106).
isEscape("_intext",107).
isEscape("_outchar",108).
isEscape("_outbyte",109).
isEscape("_outbytes",110).
isEscape("_outtext",111).
isEscape("_stdfile",112).
isEscape("_fposition",113).
isEscape("_fseek",114).
isEscape("_flush",115).
isEscape("_flushall",116).
isEscape("_setfileencoding",117).
isEscape("_get_file",118).
isEscape("_put_file",119).
isEscape("_show",120).
isEscape("_install_pkg",121).
isEscape("_pkg_is_present",122).
isEscape("_in_manifest",123).
isEscape("_locate_in_manifest",124).
isEscape("_logmsg",125).
isEscape("_connect",126).
isEscape("_listen",127).
isEscape("_accept",128).
isEscape("_hosttoip",129).
isEscape("_iptohost",130).
isEscape("_delay",131).
isEscape("_sleep",132).
isEscape("_now",133).
isEscape("_today",134).
isEscape("_ticks",135).
isEscape("_time2date",136).
isEscape("_time2utc",137).
isEscape("_date2time",138).
isEscape("_utc2time",139).
isEscape("_uniCodeCategory",140).
isEscape("_isCcChar",141).
isEscape("_isCfChar",142).
isEscape("_isCnChar",143).
isEscape("_isCoChar",144).
isEscape("_isCsChar",145).
isEscape("_isLlChar",146).
isEscape("_isLmChar",147).
isEscape("_isLoChar",148).
isEscape("_isLtChar",149).
isEscape("_isLuChar",150).
isEscape("_isMcChar",151).
isEscape("_isMeChar",152).
isEscape("_isMnChar",153).
isEscape("_isNdChar",154).
isEscape("_isNlChar",155).
isEscape("_isNoChar",156).
isEscape("_isPcChar",157).
isEscape("_isPdChar",158).
isEscape("_isPeChar",159).
isEscape("_isPfChar",160).
isEscape("_isPiChar",161).
isEscape("_isPoChar",162).
isEscape("_isPsChar",163).
isEscape("_isScChar",164).
isEscape("_isSkChar",165).
isEscape("_isSmChar",166).
isEscape("_isSoChar",167).
isEscape("_isZlChar",168).
isEscape("_isZpChar",169).
isEscape("_isZsChar",170).
isEscape("_isLetterChar",171).
isEscape("_digitCode",172).
isEscape("_codePoint",173).
isEscape("_char",174).
isEscape("_isIDStart",175).
isEscape("_isIDContinue",176).
isEscape("_int2str",177).
isEscape("_flt2str",178).
isEscape("_int_format",179).
isEscape("_flt_format",180).
isEscape("_str2flt",181).
isEscape("_str2int",182).
isEscape("_chr_eq",183).
isEscape("_chr_lt",184).
isEscape("_chr_ge",185).
isEscape("_chr_hash",186).
isEscape("_chr_quote",187).
isEscape("_chr_format",188).
isEscape("_str_eq",189).
isEscape("_str_lt",190).
isEscape("_str_ge",191).
isEscape("_str_hash",192).
isEscape("_str_len",193).
isEscape("_str_gen",194).
isEscape("_stringOf",195).
isEscape("_explode",196).
isEscape("_implode",197).
isEscape("_str_find",198).
isEscape("_sub_str",199).
isEscape("_str_split",200).
isEscape("_str_concat",201).
isEscape("_str_reverse",202).
isEscape("_str_start",203).
isEscape("_str_splice",204).
isEscape("_str_multicat",205).
isEscape("_str_hdtl",206).
isEscape("_str_back",207).
isEscape("_str_cons",208).
isEscape("_code2str",209).
isEscape("_str_apnd",210).
isEscape("_str_quote",211).
isEscape("_str_format",212).
isEscape("_getenv",213).
isEscape("_setenv",214).
isEscape("_envir",215).
isEscape("_getlogin",216).
isEscape("_fork",217).
isEscape("_thread",218).
isEscape("_kill",219).
isEscape("_thread_state",220).
isEscape("_waitfor",221).
isEscape("_shell",222).
isEscape("_newLock",223).
isEscape("_acquireLock",224).
isEscape("_waitLock",225).
isEscape("_releaseLock",226).
isEscape("_ins_debug",227).
isEscape("_stackTrace",228).
