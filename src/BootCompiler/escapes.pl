...
isEscape("_str_end",223).
isEscape("_str_splice",224).
isEscape("_str_multicat",225).
isEscape("_str_hdtl",226).
isEscape("_str_back",227).
isEscape("_str_cons",228).
isEscape("_code2str",229).
isEscape("_str_apnd",230).
isEscape("_str_quote",231).
isEscape("_str_format",232).
isEscape("_getenv",233).
isEscape("_setenv",234).
isEscape("_envir",235).
isEscape("_getlogin",236).
isEscape("_fork",237).
isEscape("_thread",238).
isEscape("_kill",239).
isEscape("_thread_state",240).
isEscape("_waitfor",241).
isEscape("_shell",242).
isEscape("_newLock",243).
isEscape("_acquireLock",244).
isEscape("_waitLock",245).
isEscape("_releaseLock",246).
isEscape("_ins_debug",247).
isEscape("_stackTrace",248).
