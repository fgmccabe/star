...
escapeType("_inchars",constrained(funType(tplType([type("ioHandle"),type("star.core*integer")]),type("star.core*string")),raises(type("star.core*errorCode")))).
escapeType("_inchars_async",constrained(funType(tplType([type("ioHandle"),type("star.core*integer")]),tpExp(tpExp(tpFun("future",2),type("star.core*string")),type("star.core*errorCode"))),raises(type("star.core*errorCode")))).
escapeType("_inchar",constrained(funType(tplType([type("ioHandle")]),type("star.core*char")),raises(type("star.core*errorCode")))).
escapeType("_inchar_async",constrained(funType(tplType([type("ioHandle")]),tpExp(tpExp(tpFun("future",2),type("star.core*char")),type("star.core*errorCode"))),raises(type("star.core*errorCode")))).
escapeType("_inbyte",constrained(funType(tplType([type("ioHandle")]),type("star.core*integer")),raises(type("star.core*errorCode")))).
escapeType("_inbyte_async",constrained(funType(tplType([type("ioHandle")]),tpExp(tpExp(tpFun("future",2),type("star.core*integer")),type("star.core*errorCode"))),raises(type("star.core*errorCode")))).
...
escapeType("_inbytes_async",constrained(funType(tplType([type("ioHandle"),type("star.core*integer")]),tpExp(tpExp(tpFun("future",2),tpExp(tpFun("star.vector*vect",1),type("star.core*integer"))),type("star.core*errorCode"))),raises(type("star.core*errorCode")))).
escapeType("_inline",constrained(funType(tplType([type("ioHandle")]),type("star.core*string")),raises(type("star.core*errorCode")))).
escapeType("_inline_async",constrained(funType(tplType([type("ioHandle")]),tpExp(tpExp(tpFun("future",2),type("star.core*string")),type("star.core*errorCode"))),raises(type("star.core*errorCode")))).
