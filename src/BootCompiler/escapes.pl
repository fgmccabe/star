...
isEscape("_connect",139).
isEscape("_listen",140).
isEscape("_accept",141).
isEscape("_hosttoip",142).
isEscape("_iptohost",143).
isEscape("_delay",144).
isEscape("_sleep",145).
isEscape("_now",146).
isEscape("_today",147).
isEscape("_ticks",148).
isEscape("_time2date",149).
isEscape("_time2utc",150).
isEscape("_date2time",151).
isEscape("_utc2time",152).
isEscape("_uniCodeCategory",153).
isEscape("_isCcChar",154).
isEscape("_isCfChar",155).
isEscape("_isCnChar",156).
isEscape("_isCoChar",157).
isEscape("_isCsChar",158).
isEscape("_isLlChar",159).
isEscape("_isLmChar",160).
isEscape("_isLoChar",161).
isEscape("_isLtChar",162).
isEscape("_isLuChar",163).
isEscape("_isMcChar",164).
isEscape("_isMeChar",165).
isEscape("_isMnChar",166).
isEscape("_isNdChar",167).
isEscape("_isNlChar",168).
isEscape("_isNoChar",169).
isEscape("_isPcChar",170).
isEscape("_isPdChar",171).
isEscape("_isPeChar",172).
isEscape("_isPfChar",173).
isEscape("_isPiChar",174).
isEscape("_isPoChar",175).
isEscape("_isPsChar",176).
isEscape("_isScChar",177).
isEscape("_isSkChar",178).
isEscape("_isSmChar",179).
isEscape("_isSoChar",180).
isEscape("_isZlChar",181).
isEscape("_isZpChar",182).
isEscape("_isZsChar",183).
isEscape("_isLetterChar",184).
isEscape("_digitCode",185).
isEscape("_codePoint",186).
isEscape("_char",187).
isEscape("_isIDStart",188).
isEscape("_isIDContinue",189).
isEscape("_int2str",190).
isEscape("_flt2str",191).
isEscape("_int_format",192).
isEscape("_flt_format",193).
isEscape("_str2flt",194).
isEscape("_str2int",195).
isEscape("_chr_eq",196).
isEscape("_chr_lt",197).
isEscape("_chr_ge",198).
isEscape("_chr_hash",199).
isEscape("_chr_quote",200).
isEscape("_chr_format",201).
isEscape("_str_eq",202).
isEscape("_str_lt",203).
isEscape("_str_ge",204).
isEscape("_str_hash",205).
isEscape("_str_len",206).
isEscape("_str_gen",207).
isEscape("_stringOf",208).
isEscape("_explode",209).
isEscape("_implode",210).
isEscape("_str_find",211).
isEscape("_sub_str",212).
isEscape("_str_split",213).
isEscape("_str_concat",214).
isEscape("_str_reverse",215).
isEscape("_str_start",216).
...
isEscape("_envir",228).
isEscape("_getlogin",229).
isEscape("_fork",230).
isEscape("_thread",231).
isEscape("_kill",232).
isEscape("_thread_state",233).
isEscape("_waitfor",234).
isEscape("_shell",235).
isEscape("_newLock",236).
isEscape("_acquireLock",237).
isEscape("_waitLock",238).
isEscape("_releaseLock",239).
isEscape("_ins_debug",240).
isEscape("_stackTrace",241).
