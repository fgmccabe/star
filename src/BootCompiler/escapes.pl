...
escapeType("_ready",funType(tupleType([type("star.io*fileHandle")]),type("star.core*boolean"))).
...
escapeType("_pkg_is_present",funType(tupleType([type("star.core*string"),type("star.core*string"),type("star.core*string"),type("star.core*string")]),type("star.core*boolean"))).
