...
escapeType("_code2str",funType(tplType([type("star.core*integer")]),type("star.core*string"))).
...
isEscape("_chr_eq",167).
isEscape("_chr_lt",168).
isEscape("_chr_ge",169).
isEscape("_chr_hash",170).
isEscape("_chr_quote",171).
isEscape("_str_eq",172).
isEscape("_str_lt",173).
isEscape("_str_ge",174).
isEscape("_str_hash",175).
isEscape("_str_len",176).
isEscape("_str_gen",177).
isEscape("_stringOf",178).
isEscape("_explode",179).
isEscape("_implode",180).
isEscape("_str_find",181).
isEscape("_sub_str",182).
isEscape("_str_split",183).
isEscape("_str_concat",184).
isEscape("_str_reverse",185).
isEscape("_str_start",186).
isEscape("_str_splice",187).
isEscape("_str_multicat",188).
isEscape("_str_hdtl",189).
isEscape("_str_back",190).
isEscape("_str_cons",191).
isEscape("_code2str",192).
isEscape("_str_apnd",193).
isEscape("_str_quote",194).
isEscape("_str_format",195).
isEscape("_getenv",196).
isEscape("_setenv",197).
isEscape("_envir",198).
isEscape("_getlogin",199).
isEscape("_fork",200).
isEscape("_thread",201).
isEscape("_kill",202).
isEscape("_thread_state",203).
isEscape("_waitfor",204).
isEscape("_shell",205).
isEscape("_newLock",206).
isEscape("_acquireLock",207).
isEscape("_waitLock",208).
isEscape("_releaseLock",209).
isEscape("_ins_debug",210).
isEscape("_stackTrace",211).
