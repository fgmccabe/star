...
isEscape("_isIDStart",159).
isEscape("_isIDContinue",160).
isEscape("_int2str",161).
isEscape("_flt2str",162).
isEscape("_int_format",163).
isEscape("_flt_format",164).
isEscape("_str2flt",165).
isEscape("_str2int",166).
isEscape("_str_eq",167).
isEscape("_string_eq",168).
isEscape("_str_lt",169).
isEscape("_str_ge",170).
isEscape("_str_hash",171).
isEscape("_string_len",172).
isEscape("_str_len",173).
isEscape("_str_gen",174).
isEscape("_stringOf",175).
isEscape("_explode",176).
isEscape("_implode",177).
isEscape("_str_find",178).
isEscape("_sub_str",179).
isEscape("_str_split",180).
isEscape("_str_concat",181).
isEscape("_str_reverse",182).
isEscape("_str_start",183).
isEscape("_str_splice",184).
isEscape("_str_multicat",185).
isEscape("_str_fltn",186).
isEscape("_str_hdtl",187).
isEscape("_str_back",188).
isEscape("_str_cons",189).
isEscape("_code2str",190).
isEscape("_str_apnd",191).
isEscape("_str_quote",192).
isEscape("_str_format",193).
isEscape("_getenv",194).
isEscape("_setenv",195).
isEscape("_envir",196).
isEscape("_getlogin",197).
isEscape("_fork",198).
isEscape("_thread",199).
isEscape("_kill",200).
isEscape("_thread_state",201).
isEscape("_waitfor",202).
isEscape("_shell",203).
isEscape("_newLock",204).
isEscape("_acquireLock",205).
isEscape("_waitLock",206).
isEscape("_releaseLock",207).
isEscape("_ins_debug",208).
isEscape("_stackTrace",209).
