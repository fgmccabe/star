...
isEscape("_inline_async",110).
isEscape("_intext",111).
isEscape("_outchar",112).
isEscape("_outbyte",113).
isEscape("_outbytes",114).
isEscape("_outtext",115).
isEscape("_stdfile",116).
isEscape("_fposition",117).
isEscape("_fseek",118).
isEscape("_flush",119).
isEscape("_flushall",120).
isEscape("_setfileencoding",121).
isEscape("_get_file",122).
isEscape("_put_file",123).
isEscape("_show",124).
isEscape("_install_pkg",125).
isEscape("_pkg_is_present",126).
isEscape("_in_manifest",127).
isEscape("_locate_in_manifest",128).
isEscape("_logmsg",129).
isEscape("_connect",130).
isEscape("_listen",131).
isEscape("_accept",132).
isEscape("_hosttoip",133).
isEscape("_iptohost",134).
isEscape("_delay",135).
isEscape("_sleep",136).
isEscape("_now",137).
isEscape("_today",138).
isEscape("_ticks",139).
isEscape("_time2date",140).
isEscape("_time2utc",141).
isEscape("_date2time",142).
isEscape("_utc2time",143).
isEscape("_uniCodeCategory",144).
isEscape("_isCcChar",145).
isEscape("_isCfChar",146).
isEscape("_isCnChar",147).
isEscape("_isCoChar",148).
isEscape("_isCsChar",149).
isEscape("_isLlChar",150).
isEscape("_isLmChar",151).
isEscape("_isLoChar",152).
isEscape("_isLtChar",153).
isEscape("_isLuChar",154).
isEscape("_isMcChar",155).
isEscape("_isMeChar",156).
isEscape("_isMnChar",157).
isEscape("_isNdChar",158).
isEscape("_isNlChar",159).
isEscape("_isNoChar",160).
isEscape("_isPcChar",161).
isEscape("_isPdChar",162).
isEscape("_isPeChar",163).
isEscape("_isPfChar",164).
isEscape("_isPiChar",165).
isEscape("_isPoChar",166).
isEscape("_isPsChar",167).
isEscape("_isScChar",168).
isEscape("_isSkChar",169).
isEscape("_isSmChar",170).
isEscape("_isSoChar",171).
isEscape("_isZlChar",172).
isEscape("_isZpChar",173).
isEscape("_isZsChar",174).
isEscape("_isLetterChar",175).
isEscape("_digitCode",176).
isEscape("_codePoint",177).
isEscape("_char",178).
isEscape("_isIDStart",179).
isEscape("_isIDContinue",180).
isEscape("_int2str",181).
isEscape("_flt2str",182).
isEscape("_int_format",183).
isEscape("_flt_format",184).
isEscape("_str2flt",185).
isEscape("_str2int",186).
isEscape("_chr_eq",187).
isEscape("_chr_lt",188).
isEscape("_chr_ge",189).
isEscape("_chr_hash",190).
isEscape("_chr_quote",191).
isEscape("_chr_format",192).
isEscape("_str_eq",193).
isEscape("_str_lt",194).
isEscape("_str_ge",195).
isEscape("_str_hash",196).
isEscape("_str_len",197).
isEscape("_str_gen",198).
isEscape("_stringOf",199).
isEscape("_explode",200).
isEscape("_implode",201).
isEscape("_str_find",202).
isEscape("_sub_str",203).
isEscape("_str_split",204).
isEscape("_str_concat",205).
isEscape("_str_reverse",206).
isEscape("_str_start",207).
isEscape("_str_splice",208).
isEscape("_str_multicat",209).
isEscape("_str_hdtl",210).
isEscape("_str_back",211).
isEscape("_str_cons",212).
isEscape("_code2str",213).
isEscape("_str_apnd",214).
isEscape("_str_quote",215).
isEscape("_str_format",216).
isEscape("_getenv",217).
isEscape("_setenv",218).
isEscape("_envir",219).
isEscape("_getlogin",220).
isEscape("_fork",221).
isEscape("_thread",222).
isEscape("_kill",223).
isEscape("_thread_state",224).
isEscape("_waitfor",225).
isEscape("_shell",226).
isEscape("_newLock",227).
isEscape("_acquireLock",228).
isEscape("_waitLock",229).
isEscape("_releaseLock",230).
isEscape("_ins_debug",231).
isEscape("_stackTrace",232).
