...
escapeType("_str2big",funType(tplType([type("star.core*string")]),type("star.core*bigint"))).
...
isEscape("_big_hash",34).
isEscape("_big_eq",35).
isEscape("_big_lt",36).
isEscape("_big_ge",37).
isEscape("_int2big",38).
isEscape("_ints2big",39).
isEscape("_big2ints",40).
isEscape("_str2big",41).
isEscape("_big2str",42).
isEscape("sqrt",43).
isEscape("exp",44).
isEscape("log",45).
isEscape("log10",46).
...
isEscape("_get",72).
isEscape("_assign",73).
isEscape("_overwrite",74).
isEscape("_tuple_nth",75).
isEscape("_tuple_set_nth",76).
isEscape("_cwd",77).
isEscape("_cd",78).
isEscape("_rm",79).
isEscape("_mv",80).
...
isEscape("_rmdir",82).
isEscape("_isdir",83).
isEscape("_file_chmod",84).
isEscape("_ls",85).
isEscape("_repo",86).
isEscape("_file_mode",87).
isEscape("_file_present",88).
isEscape("_file_type",89).
isEscape("_file_size",90).
isEscape("_file_modified",91).
isEscape("_file_date",92).
isEscape("_openInFile",93).
isEscape("_openOutFile",94).
isEscape("_openAppendFile",95).
isEscape("_openAppendIOFile",96).
isEscape("_popen",97).
isEscape("_close",98).
isEscape("_end_of_file",99).
isEscape("_ready_to_read",100).
isEscape("_ready_to_write",101).
isEscape("_inchars",102).
isEscape("_inchar",103).
isEscape("_inbyte",104).
isEscape("_inline",105).
isEscape("_intext",106).
isEscape("_outchar",107).
isEscape("_outbyte",108).
isEscape("_outbytes",109).
isEscape("_outtext",110).
isEscape("_stdfile",111).
isEscape("_fposition",112).
isEscape("_fseek",113).
isEscape("_flush",114).
isEscape("_flushall",115).
isEscape("_setfileencoding",116).
isEscape("_get_file",117).
isEscape("_put_file",118).
isEscape("_show",119).
isEscape("_install_pkg",120).
isEscape("_pkg_is_present",121).
isEscape("_in_manifest",122).
isEscape("_locate_in_manifest",123).
isEscape("_logmsg",124).
isEscape("_connect",125).
isEscape("_listen",126).
isEscape("_accept",127).
isEscape("_hosttoip",128).
isEscape("_iptohost",129).
isEscape("_delay",130).
isEscape("_sleep",131).
isEscape("_now",132).
isEscape("_today",133).
isEscape("_ticks",134).
isEscape("_time2date",135).
isEscape("_time2utc",136).
isEscape("_date2time",137).
isEscape("_utc2time",138).
isEscape("_uniCodeCategory",139).
isEscape("_isCcChar",140).
isEscape("_isCfChar",141).
isEscape("_isCnChar",142).
isEscape("_isCoChar",143).
isEscape("_isCsChar",144).
isEscape("_isLlChar",145).
isEscape("_isLmChar",146).
isEscape("_isLoChar",147).
isEscape("_isLtChar",148).
isEscape("_isLuChar",149).
isEscape("_isMcChar",150).
isEscape("_isMeChar",151).
isEscape("_isMnChar",152).
isEscape("_isNdChar",153).
isEscape("_isNlChar",154).
isEscape("_isNoChar",155).
isEscape("_isPcChar",156).
isEscape("_isPdChar",157).
isEscape("_isPeChar",158).
isEscape("_isPfChar",159).
isEscape("_isPiChar",160).
isEscape("_isPoChar",161).
isEscape("_isPsChar",162).
isEscape("_isScChar",163).
isEscape("_isSkChar",164).
isEscape("_isSmChar",165).
isEscape("_isSoChar",166).
isEscape("_isZlChar",167).
isEscape("_isZpChar",168).
isEscape("_isZsChar",169).
isEscape("_isLetterChar",170).
isEscape("_digitCode",171).
isEscape("_codePoint",172).
isEscape("_char",173).
isEscape("_isIDStart",174).
isEscape("_isIDContinue",175).
isEscape("_int2str",176).
isEscape("_flt2str",177).
isEscape("_int_format",178).
isEscape("_flt_format",179).
isEscape("_str2flt",180).
isEscape("_str2int",181).
isEscape("_chr_eq",182).
isEscape("_chr_lt",183).
isEscape("_chr_ge",184).
isEscape("_chr_hash",185).
isEscape("_chr_quote",186).
isEscape("_chr_format",187).
isEscape("_str_eq",188).
isEscape("_str_lt",189).
isEscape("_str_ge",190).
isEscape("_str_hash",191).
isEscape("_str_len",192).
isEscape("_str_gen",193).
isEscape("_stringOf",194).
isEscape("_explode",195).
isEscape("_implode",196).
isEscape("_str_find",197).
isEscape("_sub_str",198).
isEscape("_str_split",199).
isEscape("_str_concat",200).
isEscape("_str_reverse",201).
isEscape("_str_start",202).
isEscape("_str_splice",203).
isEscape("_str_multicat",204).
isEscape("_str_hdtl",205).
isEscape("_str_back",206).
isEscape("_str_cons",207).
isEscape("_code2str",208).
isEscape("_str_apnd",209).
isEscape("_str_quote",210).
isEscape("_str_format",211).
isEscape("_getenv",212).
isEscape("_setenv",213).
isEscape("_envir",214).
isEscape("_getlogin",215).
isEscape("_fork",216).
isEscape("_thread",217).
isEscape("_kill",218).
isEscape("_thread_state",219).
isEscape("_waitfor",220).
isEscape("_shell",221).
isEscape("_newLock",222).
isEscape("_acquireLock",223).
isEscape("_waitLock",224).
isEscape("_releaseLock",225).
isEscape("_ins_debug",226).
isEscape("_stackTrace",227).
