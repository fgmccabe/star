...
escapeType("_single",allType(kVar("t"),funType(tplType([]),tpExp(tpFun("single",1),kVar("t"))))).
escapeType("_singleIsSet",allType(kVar("t"),funType(tplType([tpExp(tpFun("single",1),kVar("t"))]),type("star.core*boolean")))).
escapeType("_singleVal",allType(kVar("t"),constrained(funType(tplType([tpExp(tpFun("single",1),kVar("t"))]),type("star.core*boolean")),raises(type("star.core*errorCode"))))).
escapeType("_singleSet",allType(kVar("t"),constrained(funType(tplType([tpExp(tpFun("single",1),kVar("t")),kVar("t")]),tplType([])),raises(type("star.core*errorCode"))))).
...
escapeType("_openInFile",constrained(funType(tplType([type("star.core*string"),type("star.core*integer")]),type("ioHandle")),raises(type("star.core*errorCode")))).
escapeType("_openOutFile",constrained(funType(tplType([type("star.core*string"),type("star.core*integer")]),type("ioHandle")),raises(type("star.core*errorCode")))).
escapeType("_openAppendFile",constrained(funType(tplType([type("star.core*string"),type("star.core*integer")]),type("ioHandle")),raises(type("star.core*errorCode")))).
escapeType("_openAppendIOFile",constrained(funType(tplType([type("star.core*string"),type("star.core*integer")]),type("ioHandle")),raises(type("star.core*errorCode")))).
escapeType("_popen",constrained(funType(tplType([type("star.core*string"),tpExp(tpFun("star.core*cons",1),type("star.core*string")),tpExp(tpFun("star.core*cons",1),tplType([type("star.core*string"),type("star.core*string")]))]),tplType([type("ioHandle"),type("ioHandle"),type("ioHandle")])),raises(type("star.core*errorCode")))).
escapeType("_close",constrained(funType(tplType([type("ioHandle")]),tplType([])),raises(type("star.core*errorCode")))).
escapeType("_end_of_file",funType(tplType([type("ioHandle")]),type("star.core*boolean"))).
escapeType("_ready_to_read",funType(tplType([type("ioHandle")]),type("star.core*boolean"))).
escapeType("_ready_to_write",funType(tplType([type("ioHandle")]),type("star.core*boolean"))).
escapeType("_inchars",funType(tplType([type("ioHandle"),type("star.core*integer")]),type("star.core*string"))).
escapeType("_inbytes",constrained(funType(tplType([type("ioHandle"),type("star.core*integer")]),tpExp(tpFun("star.vector*vect",1),type("star.core*integer"))),raises(type("star.core*errorCode")))).
escapeType("_enqueue_read",funType(tplType([type("ioHandle"),type("star.core*integer")]),tpExp(tpFun("single",1),tpExp(tpFun("star.core*cons",1),type("star.core*integer"))))).
escapeType("_inchar",constrained(funType(tplType([type("ioHandle")]),type("star.core*char")),raises(type("star.core*errorCode")))).
escapeType("_inchar_async",funType(tplType([type("ioHandle")]),tpExp(tpExp(tpFun("future",2),type("star.core*char")),type("star.core*errorCode")))).
escapeType("_inbyte",constrained(funType(tplType([type("ioHandle")]),type("star.core*integer")),raises(type("star.core*errorCode")))).
escapeType("_inline",constrained(funType(tplType([type("ioHandle")]),type("star.core*string")),raises(type("star.core*errorCode")))).
escapeType("_inline_async",funType(tplType([type("ioHandle")]),tpExp(tpFun("single",1),type("star.core*string")))).
escapeType("_intext",constrained(funType(tplType([type("ioHandle"),type("star.core*string")]),type("star.core*string")),raises(type("star.core*errorCode")))).
escapeType("_outchar",constrained(funType(tplType([type("ioHandle"),type("star.core*integer")]),tplType([])),raises(type("star.core*errorCode")))).
...
escapeType("_connect",constrained(funType(tplType([type("star.core*string"),type("star.core*integer"),type("star.core*integer")]),tplType([type("ioHandle"),type("ioHandle")])),raises(type("star.core*errorCode")))).
escapeType("_listen",constrained(funType(tplType([type("star.core*integer")]),type("ioHandle")),raises(type("star.core*errorCode")))).
escapeType("_accept",constrained(funType(tplType([type("ioHandle")]),tplType([type("ioHandle"),type("ioHandle"),type("star.core*string"),type("star.core*integer"),type("star.core*string")])),raises(type("star.core*errorCode")))).
