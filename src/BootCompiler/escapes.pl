...
escapeType("_int_lg2",constrained(funType(tplType([type("integer")]),type("integer")),raises(type("errorCode")))).
...
escapeType("_flt_div",constrained(funType(tplType([type("float"),type("float")]),type("float")),raises(type("errorCode")))).
escapeType("_flt_mod",constrained(funType(tplType([type("float"),type("float")]),type("float")),raises(type("errorCode")))).
...
escapeType("_int_pow",constrained(funType(tplType([type("integer"),type("integer")]),type("integer")),raises(type("errorCode")))).
...
escapeType("_big_div",constrained(funType(tplType([type("bigint"),type("bigint")]),tplType([type("bigint"),type("bigint")])),raises(type("errorCode")))).
...
escapeType("exp",funType(tplType([type("float")]),tpExp(tpExp(tpFun("result",2),type("float")),type("errorCode")))).
...
escapeType("_mv",constrained(funType(tplType([type("string"),type("string")]),tplType([])),raises(type("errorCode")))).
escapeType("_mkdir",constrained(funType(tplType([type("string"),type("integer")]),tplType([])),raises(type("errorCode")))).
escapeType("_rmdir",constrained(funType(tplType([type("string")]),tplType([])),raises(type("errorCode")))).
escapeType("_isdir",funType(tplType([type("string")]),type("boolean"))).
escapeType("_file_chmod",constrained(funType(tplType([type("string"),type("integer")]),tplType([])),raises(type("errorCode")))).
escapeType("_ls",constrained(funType(tplType([type("string")]),tpExp(tpFun("cons",1),type("string"))),raises(type("errorCode")))).
escapeType("_repo",funType(tplType([]),type("string"))).
escapeType("_file_mode",constrained(funType(tplType([type("string")]),type("integer")),raises(type("errorCode")))).
escapeType("_file_present",funType(tplType([type("string")]),type("boolean"))).
escapeType("_file_type",constrained(funType(tplType([type("string")]),type("integer")),raises(type("errorCode")))).
escapeType("_file_size",constrained(funType(tplType([type("string")]),type("integer")),raises(type("errorCode")))).
escapeType("_file_modified",constrained(funType(tplType([type("string")]),type("integer")),raises(type("errorCode")))).
escapeType("_file_date",constrained(funType(tplType([type("string")]),tplType([type("integer"),type("integer"),type("integer")])),raises(type("errorCode")))).
escapeType("_openInFile",constrained(funType(tplType([type("string"),type("integer")]),type("ioHandle")),raises(type("errorCode")))).
escapeType("_openOutFile",constrained(funType(tplType([type("string"),type("integer")]),type("ioHandle")),raises(type("errorCode")))).
escapeType("_openAppendFile",constrained(funType(tplType([type("string"),type("integer")]),type("ioHandle")),raises(type("errorCode")))).
escapeType("_openAppendIOFile",constrained(funType(tplType([type("string"),type("integer")]),type("ioHandle")),raises(type("errorCode")))).
escapeType("_popen",constrained(funType(tplType([type("string"),tpExp(tpFun("cons",1),type("string")),tpExp(tpFun("cons",1),tplType([type("string"),type("string")]))]),tplType([type("ioHandle"),type("ioHandle"),type("ioHandle")])),raises(type("errorCode")))).
escapeType("_close",constrained(funType(tplType([type("ioHandle")]),tplType([])),raises(type("errorCode")))).
escapeType("_end_of_file",funType(tplType([type("ioHandle")]),type("boolean"))).
escapeType("_inchars",constrained(funType(tplType([type("ioHandle"),type("integer")]),type("string")),raises(type("errorCode")))).
escapeType("_inchars_async",constrained(funType(tplType([type("ioHandle"),type("integer")]),tpExp(tpExp(tpFun("future",2),type("string")),type("errorCode"))),raises(type("errorCode")))).
escapeType("_inchar",constrained(funType(tplType([type("ioHandle")]),type("char")),raises(type("errorCode")))).
escapeType("_inchar_async",constrained(funType(tplType([type("ioHandle")]),tpExp(tpExp(tpFun("future",2),type("char")),type("errorCode"))),raises(type("errorCode")))).
escapeType("_inbyte",constrained(funType(tplType([type("ioHandle")]),type("integer")),raises(type("errorCode")))).
escapeType("_inbyte_async",constrained(funType(tplType([type("ioHandle")]),tpExp(tpExp(tpFun("future",2),type("integer")),type("errorCode"))),raises(type("errorCode")))).
escapeType("_inbytes",constrained(funType(tplType([type("ioHandle"),type("integer")]),tpExp(tpFun("star.vector*vect",1),type("integer"))),raises(type("errorCode")))).
escapeType("_inbytes_async",constrained(funType(tplType([type("ioHandle"),type("integer")]),tpExp(tpExp(tpFun("future",2),tpExp(tpFun("star.vector*vect",1),type("integer"))),type("errorCode"))),raises(type("errorCode")))).
escapeType("_inline",constrained(funType(tplType([type("ioHandle")]),type("string")),raises(type("errorCode")))).
escapeType("_inline_async",constrained(funType(tplType([type("ioHandle")]),tpExp(tpExp(tpFun("future",2),type("string")),type("errorCode"))),raises(type("errorCode")))).
escapeType("_outchar",constrained(funType(tplType([type("ioHandle"),type("char")]),tplType([])),raises(type("errorCode")))).
escapeType("_outchar_async",constrained(funType(tplType([type("ioHandle"),type("char")]),tpExp(tpExp(tpFun("future",2),tplType([])),type("errorCode"))),raises(type("errorCode")))).
escapeType("_outbyte",constrained(funType(tplType([type("ioHandle"),type("integer")]),tplType([])),raises(type("errorCode")))).
escapeType("_outbyte_async",constrained(funType(tplType([type("ioHandle"),type("integer")]),tpExp(tpExp(tpFun("future",2),tplType([])),type("errorCode"))),raises(type("errorCode")))).
escapeType("_outbytes",constrained(funType(tplType([type("ioHandle"),tpExp(tpFun("cons",1),type("integer"))]),tplType([])),raises(type("errorCode")))).
escapeType("_outtext",constrained(funType(tplType([type("ioHandle"),type("string")]),tplType([])),raises(type("errorCode")))).
escapeType("_outtext_async",constrained(funType(tplType([type("ioHandle"),type("string")]),tpExp(tpExp(tpFun("future",2),tplType([])),type("errorCode"))),raises(type("errorCode")))).
...
escapeType("_fseek",constrained(funType(tplType([type("ioHandle"),type("integer")]),tplType([])),raises(type("errorCode")))).
escapeType("_flush",constrained(funType(tplType([type("ioHandle")]),tplType([])),raises(type("errorCode")))).
...
escapeType("_get_file",constrained(funType(tplType([type("string")]),type("string")),raises(type("errorCode")))).
escapeType("_put_file",constrained(funType(tplType([type("string"),type("string")]),tplType([])),raises(type("errorCode")))).
escapeType("_show",funType(tplType([type("string")]),tplType([]))).
escapeType("_install_pkg",constrained(funType(tplType([type("string")]),tpExp(tpFun("cons",1),tplType([type("string"),type("string")]))),raises(type("errorCode")))).
escapeType("_pkg_is_present",constrained(funType(tplType([type("string"),type("string")]),type("boolean")),raises(type("errorCode")))).
escapeType("_in_manifest",constrained(funType(tplType([type("string"),type("string"),type("string")]),type("boolean")),raises(type("errorCode")))).
escapeType("_locate_in_manifest",constrained(funType(tplType([type("string"),type("string"),type("string")]),type("string")),raises(type("errorCode")))).
escapeType("_logmsg",funType(tplType([type("string")]),tplType([]))).
escapeType("_display_depth",funType(tplType([]),type("integer"))).
escapeType("_connect",constrained(funType(tplType([type("string"),type("integer"),type("integer")]),tplType([type("ioHandle"),type("ioHandle")])),raises(type("errorCode")))).
escapeType("_listen",constrained(funType(tplType([type("integer")]),type("ioHandle")),raises(type("errorCode")))).
escapeType("_accept",constrained(funType(tplType([type("ioHandle")]),tplType([type("ioHandle"),type("ioHandle"),type("string"),type("integer"),type("string")])),raises(type("errorCode")))).
escapeType("_hosttoip",funType(tplType([type("string")]),tpExp(tpFun("cons",1),type("string")))).
escapeType("_iptohost",constrained(funType(tplType([type("string")]),type("string")),raises(type("errorCode")))).
escapeType("_delay",constrained(funType(tplType([type("float")]),tplType([])),raises(type("errorCode")))).
escapeType("_sleep",constrained(funType(tplType([type("float")]),tplType([])),raises(type("errorCode")))).
...
escapeType("_formattime",constrained(funType(tplType([type("float"),type("string")]),type("string")),raises(type("errorCode")))).
...
escapeType("_str_back",constrained(funType(tplType([type("string")]),tplType([type("string"),type("char")])),raises(type("errorCode")))).
...
escapeType("_setenv",constrained(funType(tplType([type("string"),type("string")]),tplType([])),raises(type("errorCode")))).
...
escapeType("_kill",constrained(funType(tplType([type("star.thread*thread")]),tplType([])),raises(type("errorCode")))).
escapeType("_thread_state",funType(tplType([type("star.thread*thread")]),type("star.thread*threadState"))).
escapeType("_waitfor",constrained(funType(tplType([type("star.thread*thread")]),tplType([])),raises(type("errorCode")))).
