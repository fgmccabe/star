...
escapeType("_inbytes",constrained(funType(tplType([type("star.file*fileHandle"),type("star.core*integer")]),tpExp(tpFun("star.vector*vect",1),type("star.core*integer"))),raises(type("star.core*errorCode")))).
...
escapeType("_inchar_async",funType(tplType([type("star.file*fileHandle"),tpExp(tpFun("ref",1),tpExp(tpFun("star.core*cons",1),tpExp(tpFun("star.core*future",2),type("star.core*char")))),type("star.core*errorCode")]),tpExp(tpFun("star.core*future",2),type("star.core*char")))).
...
escapeType("_inline",constrained(funType(tplType([type("star.file*fileHandle")]),type("star.core*string")),raises(type("star.core*errorCode")))).
escapeType("_inline_async",funType(tplType([type("star.file*fileHandle")]),tpExp(tpFun("star.core*single",1),type("star.core*string")))).
escapeType("_intext",constrained(funType(tplType([type("star.file*fileHandle"),type("star.core*string")]),type("star.core*string")),raises(type("star.core*errorCode")))).
