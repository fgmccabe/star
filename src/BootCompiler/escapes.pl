...
isEscape("_str_lt",168).
isEscape("_str_ge",169).
isEscape("_str_hash",170).
isEscape("_str_len",171).
isEscape("_str_gen",172).
isEscape("_stringOf",173).
isEscape("_explode",174).
isEscape("_implode",175).
isEscape("_str_find",176).
isEscape("_sub_str",177).
isEscape("_str_split",178).
isEscape("_str_concat",179).
isEscape("_str_reverse",180).
isEscape("_str_start",181).
isEscape("_str_splice",182).
isEscape("_str_multicat",183).
isEscape("_str_hdtl",184).
isEscape("_str_back",185).
isEscape("_str_cons",186).
isEscape("_code2str",187).
isEscape("_str_apnd",188).
isEscape("_str_quote",189).
isEscape("_str_format",190).
isEscape("_getenv",191).
isEscape("_setenv",192).
isEscape("_envir",193).
isEscape("_getlogin",194).
isEscape("_fork",195).
isEscape("_thread",196).
isEscape("_kill",197).
isEscape("_thread_state",198).
isEscape("_waitfor",199).
isEscape("_shell",200).
isEscape("_newLock",201).
isEscape("_acquireLock",202).
isEscape("_waitLock",203).
isEscape("_releaseLock",204).
isEscape("_ins_debug",205).
isEscape("_stackTrace",206).
