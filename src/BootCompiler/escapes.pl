...
isEscape("_inchar",116).
isEscape("_inbyte",117).
isEscape("_inline",118).
isEscape("_inline_async",119).
isEscape("_intext",120).
isEscape("_outchar",121).
isEscape("_outbyte",122).
isEscape("_outbytes",123).
isEscape("_outtext",124).
isEscape("_stdfile",125).
isEscape("_fposition",126).
isEscape("_fseek",127).
isEscape("_flush",128).
isEscape("_flushall",129).
isEscape("_setfileencoding",130).
isEscape("_get_file",131).
isEscape("_put_file",132).
isEscape("_show",133).
isEscape("_install_pkg",134).
isEscape("_pkg_is_present",135).
isEscape("_in_manifest",136).
isEscape("_locate_in_manifest",137).
isEscape("_logmsg",138).
isEscape("_display_depth",139).
isEscape("_connect",140).
isEscape("_listen",141).
isEscape("_accept",142).
isEscape("_hosttoip",143).
isEscape("_iptohost",144).
isEscape("_delay",145).
isEscape("_sleep",146).
isEscape("_now",147).
isEscape("_today",148).
isEscape("_ticks",149).
isEscape("_time2date",150).
isEscape("_time2utc",151).
isEscape("_date2time",152).
isEscape("_utc2time",153).
isEscape("_fmttime",154).
isEscape("_uniCodeCategory",155).
isEscape("_isCcChar",156).
isEscape("_isCfChar",157).
isEscape("_isCnChar",158).
isEscape("_isCoChar",159).
isEscape("_isCsChar",160).
isEscape("_isLlChar",161).
isEscape("_isLmChar",162).
isEscape("_isLoChar",163).
isEscape("_isLtChar",164).
isEscape("_isLuChar",165).
isEscape("_isMcChar",166).
isEscape("_isMeChar",167).
isEscape("_isMnChar",168).
isEscape("_isNdChar",169).
isEscape("_isNlChar",170).
isEscape("_isNoChar",171).
isEscape("_isPcChar",172).
isEscape("_isPdChar",173).
isEscape("_isPeChar",174).
isEscape("_isPfChar",175).
isEscape("_isPiChar",176).
isEscape("_isPoChar",177).
isEscape("_isPsChar",178).
isEscape("_isScChar",179).
isEscape("_isSkChar",180).
isEscape("_isSmChar",181).
isEscape("_isSoChar",182).
isEscape("_isZlChar",183).
isEscape("_isZpChar",184).
isEscape("_isZsChar",185).
isEscape("_isLetterChar",186).
isEscape("_digitCode",187).
isEscape("_codePoint",188).
isEscape("_char",189).
isEscape("_isIDStart",190).
isEscape("_isIDContinue",191).
isEscape("_int2str",192).
isEscape("_flt2str",193).
isEscape("_int_format",194).
isEscape("_flt_format",195).
isEscape("_str2flt",196).
isEscape("_str2int",197).
isEscape("_chr_eq",198).
isEscape("_chr_lt",199).
isEscape("_chr_ge",200).
isEscape("_chr_hash",201).
isEscape("_chr_quote",202).
isEscape("_chr_format",203).
isEscape("_str_eq",204).
isEscape("_str_lt",205).
isEscape("_str_ge",206).
isEscape("_str_hash",207).
isEscape("_str_len",208).
isEscape("_str_gen",209).
isEscape("_stringOf",210).
isEscape("_explode",211).
isEscape("_implode",212).
isEscape("_str_find",213).
isEscape("_sub_str",214).
isEscape("_str_split",215).
isEscape("_str_concat",216).
isEscape("_str_reverse",217).
isEscape("_str_start",218).
isEscape("_str_splice",219).
isEscape("_str_multicat",220).
isEscape("_str_hdtl",221).
isEscape("_str_back",222).
isEscape("_str_cons",223).
isEscape("_code2str",224).
isEscape("_str_apnd",225).
isEscape("_str_quote",226).
isEscape("_str_format",227).
isEscape("_getenv",228).
isEscape("_setenv",229).
isEscape("_envir",230).
isEscape("_getlogin",231).
isEscape("_fork",232).
isEscape("_thread",233).
isEscape("_kill",234).
isEscape("_thread_state",235).
isEscape("_waitfor",236).
isEscape("_shell",237).
isEscape("_newLock",238).
isEscape("_acquireLock",239).
isEscape("_waitLock",240).
isEscape("_releaseLock",241).
isEscape("_ins_debug",242).
isEscape("_stackTrace",243).
