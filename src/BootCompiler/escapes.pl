...
escapeType("_abort",allType(kVar("s"),funType(tupleType([kVar("s"),type("star.core*string")]),tupleType([])))).
...
escapeType("_tuple_set_nth",allType(kVar("t"),allType(kVar("e"),funType(tupleType([kVar("t"),type("star.core*integer"),kVar("e")]),kVar("t"))))).
...
escapeType("_cd",funType(tupleType([type("star.core*string")]),type("star.core*sysResult"))).
escapeType("_rm",funType(tupleType([type("star.core*string")]),type("star.core*sysResult"))).
escapeType("_mv",funType(tupleType([type("star.core*string"),type("star.core*string")]),type("star.core*sysResult"))).
escapeType("_mkdir",funType(tupleType([type("star.core*string"),type("star.core*integer")]),type("star.core*sysResult"))).
escapeType("_rmdir",funType(tupleType([type("star.core*string")]),type("star.core*sysResult"))).
escapeType("_isdir",funType(tupleType([type("star.core*string")]),type("star.core*boolean"))).
escapeType("_file_chmod",funType(tupleType([type("star.core*string"),type("star.core*integer")]),type("star.core*sysResult"))).
...
escapeType("_openInFile",funType(tupleType([type("star.core*string"),type("star.core*integer")]),type("star.file*fileHandle"))).
escapeType("_openOutFile",funType(tupleType([type("star.core*string"),type("star.core*integer")]),type("star.file*fileHandle"))).
escapeType("_openAppendFile",funType(tupleType([type("star.core*string"),type("star.core*integer")]),type("star.file*fileHandle"))).
escapeType("_openAppendIOFile",funType(tupleType([type("star.core*string"),type("star.core*integer")]),type("star.file*fileHandle"))).
escapeType("_popen",funType(tupleType([type("star.core*string"),tpExp(tpFun("star.core*list",1),type("star.core*string")),tpExp(tpFun("star.core*list",1),tupleType([type("star.core*string"),type("star.core*string")]))]),tupleType([type("star.file*fileHandle"),type("star.file*fileHandle"),type("star.file*fileHandle")]))).
escapeType("_close",funType(tupleType([type("star.file*fileHandle")]),type("star.core*sysResult"))).
escapeType("_end_of_file",funType(tupleType([type("star.file*fileHandle")]),type("star.core*boolean"))).
escapeType("_ready_to_read",funType(tupleType([type("star.file*fileHandle")]),type("star.core*boolean"))).
escapeType("_ready_to_write",funType(tupleType([type("star.file*fileHandle")]),type("star.core*boolean"))).
escapeType("_inchars",funType(tupleType([type("star.file*fileHandle"),type("star.core*integer")]),type("star.core*string"))).
escapeType("_inbytes",funType(tupleType([type("star.file*fileHandle"),type("star.core*integer")]),tpExp(tpFun("star.core*list",1),type("star.core*integer")))).
escapeType("_inchar",funType(tupleType([type("star.file*fileHandle")]),type("star.core*integer"))).
escapeType("_inbyte",funType(tupleType([type("star.file*fileHandle")]),type("star.core*integer"))).
escapeType("_inline",funType(tupleType([type("star.file*fileHandle")]),type("star.core*string"))).
...
escapeType("_outbytes",funType(tupleType([type("star.file*fileHandle"),tpExp(tpFun("star.core*list",1),type("star.core*integer"))]),type("star.core*sysResult"))).
...
escapeType("_fseek",funType(tupleType([type("star.file*fileHandle"),type("star.core*integer")]),type("star.core*sysResult"))).
escapeType("_flush",funType(tupleType([type("star.file*fileHandle")]),type("star.core*sysResult"))).
escapeType("_flushall",funType(tupleType([]),tupleType([]))).
escapeType("_setfileencoding",funType(tupleType([type("star.file*fileHandle"),type("star.core*integer")]),type("star.core*sysResult"))).
...
escapeType("_logmsg",funType(tupleType([type("star.core*string")]),type("star.core*sysResult"))).
escapeType("_connect",funType(tupleType([type("star.core*string"),type("star.core*integer"),type("star.core*integer")]),tupleType([type("star.file*fileHandle"),type("star.file*fileHandle")]))).
escapeType("_listen",funType(tupleType([type("star.core*integer")]),type("star.file*fileHandle"))).
escapeType("_accept",funType(tupleType([type("star.file*fileHandle")]),tupleType([type("star.file*fileHandle"),type("star.file*fileHandle"),type("star.core*string"),type("star.core*integer"),type("star.core*string")]))).
...
escapeType("_delay",funType(tupleType([type("star.core*float")]),type("star.core*sysResult"))).
...
escapeType("_uniCodeCategory",funType(tupleType([type("star.core*integer")]),type("star.core*integer"))).
...
escapeType("_setenv",funType(tupleType([type("star.core*string"),type("star.core*string")]),type("star.core*sysResult"))).
...
escapeType("_acquireLock",funType(tupleType([type("star.thread*lock"),type("star.core*float")]),type("star.core*sysResult"))).
escapeType("_waitLock",funType(tupleType([type("star.thread*lock"),type("star.core*float")]),type("star.core*sysResult"))).
escapeType("_releaseLock",funType(tupleType([type("star.thread*lock")]),type("star.core*sysResult"))).
