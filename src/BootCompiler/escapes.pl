...
escapeType("_new_fiber",allType(kVar("s"),allType(kVar("r"),funType(tplType([funType(tplType([tpExp(tpExp(tpFun("star.core*fiber",2),kVar("s")),kVar("r"))]),kVar("s"))]),tpExp(tpExp(tpFun("star.core*fiber",2),kVar("s")),kVar("r")))))).
escapeType("_suspend_fiber",allType(kVar("s"),allType(kVar("r"),funType(tplType([tpExp(tpExp(tpFun("star.core*fiber",2),kVar("s")),kVar("r")),kVar("s")]),kVar("r"))))).
escapeType("_retire_fiber",allType(kVar("s"),allType(kVar("r"),funType(tplType([tpExp(tpExp(tpFun("star.core*fiber",2),kVar("s")),kVar("r")),kVar("s")]),tplType([]))))).
escapeType("_resume_fiber",allType(kVar("s"),allType(kVar("r"),funType(tplType([tpExp(tpExp(tpFun("star.core*fiber",2),kVar("s")),kVar("r")),kVar("r")]),kVar("s"))))).
...
isEscape("_suspend_fiber",48).
isEscape("_retire_fiber",49).
isEscape("_resume_fiber",50).
isEscape("sqrt",51).
isEscape("exp",52).
isEscape("log",53).
isEscape("log10",54).
...
isEscape("_get",80).
isEscape("_assign",81).
isEscape("_overwrite",82).
isEscape("_tuple_nth",83).
isEscape("_tuple_set_nth",84).
isEscape("_cwd",85).
isEscape("_cd",86).
isEscape("_rm",87).
isEscape("_mv",88).
...
isEscape("_rmdir",90).
isEscape("_isdir",91).
isEscape("_file_chmod",92).
isEscape("_ls",93).
isEscape("_repo",94).
isEscape("_file_mode",95).
isEscape("_file_present",96).
isEscape("_file_type",97).
isEscape("_file_size",98).
isEscape("_file_modified",99).
isEscape("_file_date",100).
isEscape("_openInFile",101).
isEscape("_openOutFile",102).
isEscape("_openAppendFile",103).
isEscape("_openAppendIOFile",104).
isEscape("_popen",105).
isEscape("_close",106).
isEscape("_end_of_file",107).
isEscape("_ready_to_read",108).
isEscape("_ready_to_write",109).
isEscape("_inchars",110).
isEscape("_inchar",111).
isEscape("_inbyte",112).
isEscape("_inline",113).
isEscape("_inline_async",114).
isEscape("_intext",115).
isEscape("_outchar",116).
isEscape("_outbyte",117).
isEscape("_outbytes",118).
isEscape("_outtext",119).
isEscape("_stdfile",120).
isEscape("_fposition",121).
isEscape("_fseek",122).
isEscape("_flush",123).
isEscape("_flushall",124).
isEscape("_setfileencoding",125).
isEscape("_get_file",126).
isEscape("_put_file",127).
isEscape("_show",128).
isEscape("_install_pkg",129).
isEscape("_pkg_is_present",130).
isEscape("_in_manifest",131).
isEscape("_locate_in_manifest",132).
isEscape("_logmsg",133).
isEscape("_connect",134).
isEscape("_listen",135).
isEscape("_accept",136).
isEscape("_hosttoip",137).
isEscape("_iptohost",138).
isEscape("_delay",139).
isEscape("_sleep",140).
isEscape("_now",141).
isEscape("_today",142).
isEscape("_ticks",143).
isEscape("_time2date",144).
isEscape("_time2utc",145).
isEscape("_date2time",146).
isEscape("_utc2time",147).
isEscape("_uniCodeCategory",148).
isEscape("_isCcChar",149).
isEscape("_isCfChar",150).
isEscape("_isCnChar",151).
isEscape("_isCoChar",152).
isEscape("_isCsChar",153).
isEscape("_isLlChar",154).
isEscape("_isLmChar",155).
isEscape("_isLoChar",156).
isEscape("_isLtChar",157).
isEscape("_isLuChar",158).
isEscape("_isMcChar",159).
isEscape("_isMeChar",160).
isEscape("_isMnChar",161).
isEscape("_isNdChar",162).
isEscape("_isNlChar",163).
isEscape("_isNoChar",164).
isEscape("_isPcChar",165).
isEscape("_isPdChar",166).
isEscape("_isPeChar",167).
isEscape("_isPfChar",168).
isEscape("_isPiChar",169).
isEscape("_isPoChar",170).
isEscape("_isPsChar",171).
isEscape("_isScChar",172).
isEscape("_isSkChar",173).
isEscape("_isSmChar",174).
isEscape("_isSoChar",175).
isEscape("_isZlChar",176).
isEscape("_isZpChar",177).
isEscape("_isZsChar",178).
isEscape("_isLetterChar",179).
isEscape("_digitCode",180).
isEscape("_codePoint",181).
isEscape("_char",182).
isEscape("_isIDStart",183).
isEscape("_isIDContinue",184).
isEscape("_int2str",185).
isEscape("_flt2str",186).
isEscape("_int_format",187).
isEscape("_flt_format",188).
isEscape("_str2flt",189).
isEscape("_str2int",190).
isEscape("_chr_eq",191).
isEscape("_chr_lt",192).
isEscape("_chr_ge",193).
isEscape("_chr_hash",194).
isEscape("_chr_quote",195).
isEscape("_chr_format",196).
isEscape("_str_eq",197).
isEscape("_str_lt",198).
isEscape("_str_ge",199).
isEscape("_str_hash",200).
isEscape("_str_len",201).
isEscape("_str_gen",202).
isEscape("_stringOf",203).
isEscape("_explode",204).
isEscape("_implode",205).
isEscape("_str_find",206).
isEscape("_sub_str",207).
isEscape("_str_split",208).
isEscape("_str_concat",209).
isEscape("_str_reverse",210).
isEscape("_str_start",211).
isEscape("_str_splice",212).
isEscape("_str_multicat",213).
isEscape("_str_hdtl",214).
isEscape("_str_back",215).
isEscape("_str_cons",216).
isEscape("_code2str",217).
isEscape("_str_apnd",218).
isEscape("_str_quote",219).
isEscape("_str_format",220).
isEscape("_getenv",221).
isEscape("_setenv",222).
isEscape("_envir",223).
isEscape("_getlogin",224).
isEscape("_fork",225).
isEscape("_thread",226).
isEscape("_kill",227).
isEscape("_thread_state",228).
isEscape("_waitfor",229).
isEscape("_shell",230).
isEscape("_newLock",231).
isEscape("_acquireLock",232).
isEscape("_waitLock",233).
isEscape("_releaseLock",234).
isEscape("_ins_debug",235).
isEscape("_stackTrace",236).
