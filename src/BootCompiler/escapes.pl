...
escapeType("_overwrite",allType(kVar("t"),funType(tupleType([kVar("t"),kVar("t")]),type("star.core*boolean")))).
...
escapeType("_close",funType(tupleType([type("star.io*fileHandle")]),type("star.core*sysResult"))).
...
escapeType("_outchar",funType(tupleType([type("star.io*fileHandle"),type("star.core*integer")]),type("star.core*sysResult"))).
escapeType("_outbyte",funType(tupleType([type("star.io*fileHandle"),type("star.core*integer")]),type("star.core*sysResult"))).
escapeType("_outbytes",funType(tupleType([type("star.io*fileHandle"),tpExp(tpFun("star.core*list",1),type("star.core*integer"))]),type("star.core*sysResult"))).
escapeType("_outtext",funType(tupleType([type("star.io*fileHandle"),type("star.core*string")]),type("star.core*sysResult"))).
...
escapeType("_fseek",funType(tupleType([type("star.io*fileHandle"),type("star.core*integer")]),type("star.core*sysResult"))).
escapeType("_flush",funType(tupleType([type("star.io*fileHandle")]),type("star.core*sysResult"))).
escapeType("_flushall",funType(tupleType([]),tupleType([]))).
escapeType("_setfileencoding",funType(tupleType([type("star.io*fileHandle"),type("star.core*integer")]),type("star.core*sysResult"))).
