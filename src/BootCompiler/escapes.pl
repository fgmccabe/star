...
isEscape("_get",75).
isEscape("_assign",76).
isEscape("_overwrite",77).
isEscape("_tuple_nth",78).
isEscape("_tuple_set_nth",79).
isEscape("_cwd",80).
isEscape("_cd",81).
isEscape("_rm",82).
isEscape("_mv",83).
...
isEscape("_rmdir",85).
isEscape("_isdir",86).
isEscape("_file_chmod",87).
isEscape("_ls",88).
isEscape("_repo",89).
isEscape("_file_mode",90).
isEscape("_file_present",91).
isEscape("_file_type",92).
isEscape("_file_size",93).
isEscape("_file_modified",94).
isEscape("_file_date",95).
isEscape("_openInFile",96).
isEscape("_openOutFile",97).
isEscape("_openAppendFile",98).
isEscape("_openAppendIOFile",99).
isEscape("_popen",100).
isEscape("_close",101).
isEscape("_end_of_file",102).
isEscape("_ready_to_read",103).
isEscape("_ready_to_write",104).
isEscape("_inchars",105).
isEscape("_inchar",106).
isEscape("_inbyte",107).
isEscape("_inline",108).
isEscape("_intext",109).
isEscape("_outchar",110).
isEscape("_outbyte",111).
isEscape("_outbytes",112).
isEscape("_outtext",113).
isEscape("_stdfile",114).
isEscape("_fposition",115).
isEscape("_fseek",116).
isEscape("_flush",117).
isEscape("_flushall",118).
isEscape("_setfileencoding",119).
isEscape("_get_file",120).
isEscape("_put_file",121).
isEscape("_show",122).
isEscape("_install_pkg",123).
isEscape("_pkg_is_present",124).
isEscape("_in_manifest",125).
isEscape("_locate_in_manifest",126).
isEscape("_logmsg",127).
isEscape("_connect",128).
isEscape("_listen",129).
isEscape("_accept",130).
isEscape("_hosttoip",131).
isEscape("_iptohost",132).
isEscape("_delay",133).
isEscape("_sleep",134).
isEscape("_now",135).
isEscape("_today",136).
isEscape("_ticks",137).
isEscape("_time2date",138).
isEscape("_time2utc",139).
isEscape("_date2time",140).
isEscape("_utc2time",141).
isEscape("_uniCodeCategory",142).
isEscape("_isCcChar",143).
isEscape("_isCfChar",144).
isEscape("_isCnChar",145).
isEscape("_isCoChar",146).
isEscape("_isCsChar",147).
isEscape("_isLlChar",148).
isEscape("_isLmChar",149).
isEscape("_isLoChar",150).
isEscape("_isLtChar",151).
isEscape("_isLuChar",152).
isEscape("_isMcChar",153).
isEscape("_isMeChar",154).
isEscape("_isMnChar",155).
isEscape("_isNdChar",156).
isEscape("_isNlChar",157).
isEscape("_isNoChar",158).
isEscape("_isPcChar",159).
isEscape("_isPdChar",160).
isEscape("_isPeChar",161).
isEscape("_isPfChar",162).
isEscape("_isPiChar",163).
isEscape("_isPoChar",164).
isEscape("_isPsChar",165).
isEscape("_isScChar",166).
isEscape("_isSkChar",167).
isEscape("_isSmChar",168).
isEscape("_isSoChar",169).
isEscape("_isZlChar",170).
isEscape("_isZpChar",171).
isEscape("_isZsChar",172).
isEscape("_isLetterChar",173).
isEscape("_digitCode",174).
isEscape("_codePoint",175).
isEscape("_char",176).
isEscape("_isIDStart",177).
isEscape("_isIDContinue",178).
isEscape("_int2str",179).
isEscape("_flt2str",180).
isEscape("_int_format",181).
isEscape("_flt_format",182).
isEscape("_str2flt",183).
isEscape("_str2int",184).
isEscape("_chr_eq",185).
isEscape("_chr_lt",186).
isEscape("_chr_ge",187).
isEscape("_chr_hash",188).
isEscape("_chr_quote",189).
isEscape("_chr_format",190).
isEscape("_str_eq",191).
isEscape("_str_lt",192).
isEscape("_str_ge",193).
isEscape("_str_hash",194).
isEscape("_str_len",195).
isEscape("_str_gen",196).
isEscape("_stringOf",197).
isEscape("_explode",198).
isEscape("_implode",199).
isEscape("_str_find",200).
isEscape("_sub_str",201).
isEscape("_str_split",202).
isEscape("_str_concat",203).
isEscape("_str_reverse",204).
isEscape("_str_start",205).
isEscape("_str_splice",206).
isEscape("_str_multicat",207).
isEscape("_str_hdtl",208).
isEscape("_str_back",209).
isEscape("_str_cons",210).
isEscape("_code2str",211).
isEscape("_str_apnd",212).
isEscape("_str_quote",213).
isEscape("_str_format",214).
isEscape("_getenv",215).
isEscape("_setenv",216).
isEscape("_envir",217).
isEscape("_getlogin",218).
isEscape("_fork",219).
isEscape("_thread",220).
isEscape("_kill",221).
isEscape("_thread_state",222).
isEscape("_waitfor",223).
isEscape("_shell",224).
isEscape("_newLock",225).
isEscape("_acquireLock",226).
isEscape("_waitLock",227).
isEscape("_releaseLock",228).
isEscape("_ins_debug",229).
isEscape("_stackTrace",230).
