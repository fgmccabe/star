...
isEscape("_str_splice",221).
isEscape("_str_multicat",222).
isEscape("_str_hdtl",223).
isEscape("_str_back",224).
isEscape("_str_cons",225).
isEscape("_code2str",226).
isEscape("_str_apnd",227).
isEscape("_str_quote",228).
isEscape("_str_format",229).
isEscape("_getenv",230).
isEscape("_setenv",231).
isEscape("_envir",232).
isEscape("_getlogin",233).
isEscape("_fork",234).
isEscape("_thread",235).
isEscape("_kill",236).
isEscape("_thread_state",237).
isEscape("_waitfor",238).
isEscape("_shell",239).
isEscape("_newLock",240).
isEscape("_acquireLock",241).
isEscape("_waitLock",242).
isEscape("_releaseLock",243).
isEscape("_ins_debug",244).
isEscape("_stackTrace",245).
