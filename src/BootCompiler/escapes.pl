...
isEscape("_int_gcd",11).
isEscape("_flt_plus",12).
isEscape("_flt_minus",13).
isEscape("_flt_times",14).
isEscape("_flt_div",15).
isEscape("_flt_mod",16).
isEscape("_int_abs",17).
isEscape("_flt_abs",18).
isEscape("_int_eq",19).
isEscape("_int_lt",20).
isEscape("_int_ge",21).
isEscape("_flt_eq",22).
isEscape("_flt_lt",23).
isEscape("_flt_ge",24).
isEscape("_int2flt",25).
isEscape("_flt2int",26).
isEscape("_bits_float",27).
isEscape("_float_bits",28).
isEscape("_flt_hash",29).
isEscape("_flt_pwr",30).
isEscape("_big_plus",31).
isEscape("_big_minus",32).
isEscape("_big_times",33).
isEscape("_big_div",34).
isEscape("_big_gcd",35).
isEscape("_big_hash",36).
isEscape("_big_eq",37).
isEscape("_big_lt",38).
isEscape("_big_ge",39).
isEscape("_int2big",40).
isEscape("_big2int",41).
isEscape("_ints2big",42).
isEscape("_big2ints",43).
isEscape("_str2big",44).
isEscape("_big2str",45).
isEscape("_big_format",46).
isEscape("sqrt",47).
isEscape("exp",48).
isEscape("log",49).
isEscape("log10",50).
