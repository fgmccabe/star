...
isEscape("_str_eq",174).
isEscape("_str_lt",175).
isEscape("_str_ge",176).
isEscape("_str_hash",177).
isEscape("_str_len",178).
isEscape("_str_gen",179).
isEscape("_stringOf",180).
isEscape("_explode",181).
isEscape("_implode",182).
isEscape("_str_find",183).
isEscape("_sub_str",184).
isEscape("_str_split",185).
isEscape("_str_concat",186).
isEscape("_str_reverse",187).
isEscape("_str_start",188).
isEscape("_str_splice",189).
isEscape("_str_multicat",190).
isEscape("_str_hdtl",191).
isEscape("_str_back",192).
isEscape("_str_cons",193).
isEscape("_code2str",194).
isEscape("_str_apnd",195).
isEscape("_str_quote",196).
isEscape("_str_format",197).
isEscape("_getenv",198).
isEscape("_setenv",199).
isEscape("_envir",200).
isEscape("_getlogin",201).
isEscape("_fork",202).
isEscape("_thread",203).
isEscape("_kill",204).
isEscape("_thread_state",205).
isEscape("_waitfor",206).
isEscape("_shell",207).
isEscape("_newLock",208).
isEscape("_acquireLock",209).
isEscape("_waitLock",210).
isEscape("_releaseLock",211).
isEscape("_ins_debug",212).
isEscape("_stackTrace",213).
