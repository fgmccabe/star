...
freeVars(conj(Lc,L,R),Ex,Q,F,FV) :- ptnGoalVars(conj(Lc,L,R),Ex,E1),freevars:addFrVar,freeVars(L,E1,Q,F,F0),freeVars(R,E1,Q,F0,FV).
...
freeVars(abstraction(_,B,C,Z,G,_),Ex,Q,F,FV) :-
  ptnGoalVars(C,freevars:addVar,Ex,Ex1),
