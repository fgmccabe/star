    ...
    switch (ins->op) {
      ...
      case Block: {
        ...
        if (!isString(lit)) {
          ...
          if (verifyBlock(pc - 1, pc, pc + blockLen, False, &ctx, blockEntryDepth, blockExitDepth, stackDepth+trueDepth) == Ok) {
      ...
      case Try: {
        ...
        if (!isString(lit)) {
          ...
          if (verifyBlock(pc - 1, pc, pc + blockLen, True, &ctx, blockEntryDepth, blockExitDepth, stackDepth+trueDepth) == Ok) {
